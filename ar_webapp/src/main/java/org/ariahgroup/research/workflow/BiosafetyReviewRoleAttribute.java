 ...
 */
public class BiosafetyReviewRoleAttribute extends GenericRoleAttribute {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(BiosafetyReviewRoleAttribute.class);
    ...
    public List<RoleName> getRoleNames() {
        ...
        RoleName role = RoleName.Builder.create("org.ariahgroup.research.workflow.BiosafetyReviewRoleAttribute",
    ...
    protected List<Id> resolveRecipients(RouteContext routeContext, QualifiedRoleName qualifiedRoleName) {
        ...
        if (devProp.getPropSpecialReviews() != null && !devProp.getPropSpecialReviews().isEmpty()) {
            ...
            // there are special reviews, so retrieve the value of the 'Biosafety/IBC' special review type
            ...
            String paramExportSpecialReviewType = parameterService.getParameterValueAsString(ProposalDevelopmentDocument.class,
                    Constants.ARIAH_PROPDEV_WORKFLOW_STEP_SPECREVS_IBC_REVIEW_TYPE, null);
