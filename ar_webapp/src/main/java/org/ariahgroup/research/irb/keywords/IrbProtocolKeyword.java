 ...
 * the License.
 */
package org.ariahgroup.research.irb.keywords;
...
/**
 * Class representing a keyword for IRB Protocols.
 *
 * @author The Ariah Group, Inc.
 */
public class IrbProtocolKeyword extends AbstractScienceKeyword implements SequenceAssociate<Protocol> {
    ...
    /**
     * Empty constructor for IrbProtocolKeyword.
     */
    public IrbProtocolKeyword() {
    }

    /**
     * Constructs a IrbProtocolKeyword.
     *
     * @param protocolId
     * @param scienceKeyword
     */
    public IrbProtocolKeyword(Long protocolId, ScienceKeyword scienceKeyword) {
        super();
