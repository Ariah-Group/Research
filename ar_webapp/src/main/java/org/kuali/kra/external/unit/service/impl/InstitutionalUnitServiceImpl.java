 ...
 *
 * The implementation is primarily achieved via delegation to the internal
...
public class InstitutionalUnitServiceImpl implements InstitutionalUnitService {
    ...
    /**
     * @see
     * org.kuali.kra.external.unit.service.InstitutionalUnitService#lookupUnits(java.util.List)
     */
