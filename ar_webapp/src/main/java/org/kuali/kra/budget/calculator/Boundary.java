...
/**
 * This class holds the date boundaries ie, Start Date & End Date. Also have
 * methods which to get the date related values like the no of days in
...
public class Boundary {
    ...
    /**
     * Constructor... Accepts 2 parameters, viz startDate & endDate and sets the
     ...
     *
     * @return Concatenated string representation of each element
     */
    @Override
    public String toString() {
        StringBuilder strBffr = new StringBuilder(50);
        strBffr.append("Start date=>");
        strBffr.append(startDate);
        strBffr.append(";End date=>");
        strBffr.append(endDate);
        strBffr.append("\n");
