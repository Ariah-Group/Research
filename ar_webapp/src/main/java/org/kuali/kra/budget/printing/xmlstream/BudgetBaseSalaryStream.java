...
public abstract class BudgetBaseSalaryStream extends BudgetBaseStream {
     ...
     * </p>
     *
     * @param costElementDesc is a cost element description
     * @param costElementCode is a cost element code
     * @param name is a cost element description
     * @param budgetPeriodArray is array of budget periods xml objects
     * @param total is a sum of period costs for budget period
     ...
     * </p>
     *
     * @param salaryTypeVoList is a list contains set of salary types based on
     * budget line calculated amount
     *
     */
