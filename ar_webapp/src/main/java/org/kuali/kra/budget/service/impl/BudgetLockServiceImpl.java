...
/**
 * The Budget Lock Service implementation. It derives from the Pessimistic Lock
 * Service in order to customize the lock descriptors.
 */
public class BudgetLockServiceImpl extends PessimisticLockServiceImpl implements BudgetLockService {
    ...
    /**
     * @return @see
     * org.kuali.rice.krad.service.impl.PessimisticLockServiceImpl#isLockRequiredByUser(org.kuali.rice.krad.document.Document,
    ...
    /**
     * @return @see
     * org.kuali.rice.krad.service.impl.PessimisticLockServiceImpl#isEntryEditMode(java.util.Map.Entry)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * @return @see
     * org.kuali.rice.krad.service.impl.PessimisticLockServiceImpl#createNewPessimisticLock(org.kuali.rice.krad.document.Document,
     * java.util.Map, org.kuali.rice.kim.api.identity.Person)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * @return @see
     * org.kuali.rice.krad.service.impl.PessimisticLockServiceImpl#hasPreRouteEditAuthorization(org.kuali.rice.krad.document.Document,
