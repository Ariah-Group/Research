...
public class BudgetCalculationServiceImpl implements BudgetCalculationService {
    ...
    /**
     * Checks if a calculation is required where Budget periods must be synced
     * in line items.
     *
...
//            }
    ...
    /**
     * Syncs the calculated costs in the budget document with the calculated
     * costs in the budget periods. If the certain costs are not positive then
     * lists on items related to those costs are also cleared and reset (i.e.
     * UnrecoveredFandAs). This method modifies the passed in Budget.
     *
    ...
    /**
     * Initializes items that are dependent on a cost value. (i.e.
     * UnrecoveredFandAs) This method modifies the passed in Budget.
     *
     * @param budget the budget document
     */
    ...
    /**
     * Clears and initializes the UnrecoveredFandAs in a budget document. This
     * method modifies the passed in Budget.
     *
    ...
    /**
     * Clears and initializes the CostSharing in a budget document. This method
     * modifies the passed in Budget.
     *
     * @param document the budget document.
     */
    ...
    /**
     * Ensures that a budget period has synced costs with other budget objects
     * (i.e. line items)
     *
     */
    ...
    /**
     *
     * This method sets the budget period costs from the line item costs. This
     * method modifies the passed in budget period.
     *
    ...
    /**
     * Checks if a positive Total Underrecoverary Amount exists in a line item
     * or in a budget period.
     *
     * @param document The budget Document
    ...
    /**
     * Checks if a positive Total CostSharing Amount exists in a line item or in
     * a budget period.
     *
     * @param document The budget Document
     * @return true if positive.
