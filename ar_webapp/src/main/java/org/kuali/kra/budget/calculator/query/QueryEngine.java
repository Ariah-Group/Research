...
/**
 * Contains different sets of Data Collection in Hashtable. can execute query to
 * get a subSets of the Data Collection or can add, update and delete data to a
 * Data Collection. This class is a Singleton since it has to be accessed
 * globally.
 */
public class QueryEngine {
    ...
    /**
     * removes a DatCollection(i.e. Hashtable) with the specified key from
     * QueryEngine.
     *
     * @param key key
     */
     ...
     *
     * @param key DataCollection key
     * @param beanClass Class type of the bean to locate QueryList from where
