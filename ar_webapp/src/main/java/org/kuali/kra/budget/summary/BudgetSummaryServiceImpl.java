...
public class BudgetSummaryServiceImpl implements BudgetSummaryService {
            ...
            if (budgetPeriod.getBudgetLineItems() != null) {
                for (BudgetLineItem periodLineItem : budgetPeriod.getBudgetLineItems()) {
                    if (onOffCampusFlag.equalsIgnoreCase(Constants.DEFAULT_CAMPUS_FLAG)) {
                        ...
                        periodLineItem.setOnOffCampusFlag(onOffCampusFlag.equalsIgnoreCase(Constants.ON_CAMPUS_FLAG));
                    }
                    for (BudgetPersonnelDetails periodPersonnelDetail : periodLineItem.getBudgetPersonnelDetailsList()) {
                        if (onOffCampusFlag.equalsIgnoreCase(Constants.DEFAULT_CAMPUS_FLAG)) {
                            ...
                            periodPersonnelDetail.setOnOffCampusFlag(onOffCampusFlag.equalsIgnoreCase(Constants.ON_CAMPUS_FLAG));
                        }
                    }
                }
            }
     ...
     *
     * @see
     * org.kuali.kra.budget.summary.BudgetSummaryService#adjustStartEndDatesForLineItems(org.kuali.kra.budget.core.Budget)
     */
    @Override
    ...
    /**
     *
     * This method hold the old start/end date, so it can be used for comparison
     * upon save.
     *
     * @param budget
     */
    ...
    /**
     *
     * This method is to be shared by adjusting dates for budgetperiod->lineitem
     * and lineitem->personnellineitem refer to jira-1376 for rules
     *
