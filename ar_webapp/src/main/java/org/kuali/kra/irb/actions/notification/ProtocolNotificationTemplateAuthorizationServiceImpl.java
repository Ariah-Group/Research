...
/**
 *
 * This class is to implement the detail of permission check for modify/view
...
public class ProtocolNotificationTemplateAuthorizationServiceImpl implements ProtocolNotificationTemplateAuthorizationService {
     ...
     *
     * @see
     * org.kuali.kra.irb.actions.notification.ProtocolNotificationTemplateAuthorizationService#hasPermission(java.lang.String)
     */
    @Override
    public boolean hasPermission(String permissionName) {
        KcPerson person = kcPersonService.getKcPersonByUserName(getUserName());
        return unitAuthorizationService.hasPermission(person.getPersonId(), Constants.MODULE_NAMESPACE_PROTOCOL, permissionName);
