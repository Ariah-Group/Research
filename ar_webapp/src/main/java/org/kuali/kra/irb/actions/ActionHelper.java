...
public class ActionHelper extends ActionHelperBase {
    ...
    public ActionHelper(ProtocolForm form) throws Exception {
        ...
        protocolResponseApprovalBean = (ProtocolApproveBean) buildProtocolApproveBean(ProtocolActionType.RESPONSE_APPROVAL, Constants.PROTOCOL_RESPONSE_APPROVAL_ACTION_PROPERTY_KEY);
        protocolReopenEnrollmentBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.REOPEN_ENROLLMENT, Constants.PROTOCOL_REOPEN_ENROLLMENT_ACTION_PROPERTY_KEY);
        protocolCloseEnrollmentBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.CLOSED_FOR_ENROLLMENT, Constants.PROTOCOL_CLOSE_ENROLLMENT_ACTION_PROPERTY_KEY);
        protocolSuspendByDsmbBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.SUSPENDED_BY_DSMB, Constants.PROTOCOL_SUSPEND_BY_DSMB_ACTION_PROPERTY_KEY);
        protocolCloseBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.CLOSED_ADMINISTRATIVELY_CLOSED, Constants.PROTOCOL_CLOSE_ACTION_PROPERTY_KEY);
        protocolPermitDataAnalysisBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.DATA_ANALYSIS_ONLY, Constants.PROTOCOL_PERMIT_DATA_ANALYSIS_ACTION_PROPERTY_KEY);
        protocolIrbAcknowledgementBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.IRB_ACKNOWLEDGEMENT, Constants.PROTOCOL_IRB_ACKNOWLEDGEMENT_ACTION_PROPERTY_KEY);
        ...
        protocolDeferBean = buildProtocolGenericActionBean(copiedReviewComments, protocolSubmission, ProtocolActionType.DEFERRED, Constants.PROTOCOL_DEFER_ACTION_PROPERTY_KEY);
        protocolReviewNotRequiredBean = new ProtocolReviewNotRequiredBean(this);
        protocolCloseRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_TO_CLOSE, ProtocolSubmissionType.REQUEST_TO_CLOSE, "protocolCloseRequestBean");
        protocolSuspendRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_FOR_SUSPENSION, ProtocolSubmissionType.REQUEST_FOR_SUSPENSION, "protocolSuspendRequestBean");
        protocolCloseEnrollmentRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_TO_CLOSE_ENROLLMENT, ProtocolSubmissionType.REQUEST_TO_CLOSE_ENROLLMENT, "protocolCloseEnrollmentRequestBean");
        protocolReOpenEnrollmentRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_TO_REOPEN_ENROLLMENT, ProtocolSubmissionType.REQUEST_TO_REOPEN_ENROLLMENT, "protocolReOpenEnrollmentRequestBean");
        protocolDataAnalysisRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_FOR_DATA_ANALYSIS_ONLY, ProtocolSubmissionType.REQUEST_FOR_DATA_ANALYSIS_ONLY, "protocolDataAnalysisRequestBean");
        protocolTerminateRequestBean = new ProtocolRequestBean(this, ProtocolActionType.REQUEST_FOR_TERMINATION, ProtocolSubmissionType.REQUEST_FOR_TERMINATION, "protocolTerminateRequestBean");
        protocolWithdrawSubmissionBean = new ProtocolRequestBean(this, ProtocolActionType.WITHDRAW_SUBMISSION, ProtocolSubmissionType.WITHDRAW_SUBMISSION, "protocolWithdrawSubmissionRequestBean");
    ...
    /**
     *
     * This method builds a ProtocolGenericActionBean. A number of different
     * beans in this object are of type ProtocolGenericActionBean, and all need
     * to add reviewer comments. This encapsulates that.
     *
     * @param copiedReviewComments
     * @param protocolSubmission
     * @param actionTypeCode
     * @param errorPropertyKey
     * @return a ProtocolGenericActionBean, and pre-populated with reviewer
     * comments if any exist
     */
    protected ProtocolGenericActionBean buildProtocolGenericActionBean(List<CommitteeScheduleMinuteBase> copiedReviewComments,
            ProtocolSubmission protocolSubmission, String actionTypeCode, String errorPropertyKey) {

        ProtocolGenericActionBean bean = new ProtocolGenericActionBean(this, errorPropertyKey);

        bean.getReviewCommentsBean().setReviewComments(copiedReviewComments);
        ProtocolAction protocolAction = (ProtocolAction) findProtocolAction(actionTypeCode, getProtocol().getProtocolActions(), protocolSubmission);
    ...
    /**
     * This method copies the settings from the ProtocolAmendRenewal bo to the
     * amendmentBean and enables the corresponding modules.
     *
     * @param amendmentBean
     */
    @Override
    ...
    /**
     * Enable a module for selection by a user by setting its corresponding
     * enabled flag to true in the amendment bean.
     *
    ...
    public void prepareCommentsView() {
        ...
        List<CommitteeScheduleMinuteBase> commSchedMinList = getCopiedReviewComments();

        protocolGrantExemptionBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolIrbAcknowledgementBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolExpeditedApprovalBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolResponseApprovalBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolReopenEnrollmentBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolCloseEnrollmentBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolSuspendByDsmbBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolCloseBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
        protocolPermitDataAnalysisBean.getReviewCommentsBean().setReviewComments(commSchedMinList);
...
//    }
    ...
    protected void initPrintCorrespondence() {
        ...
        List<ProtocolCorrespondenceType> correspondenceTypes = (List<ProtocolCorrespondenceType>) KraServiceLocator.getService(BusinessObjectService.class).findMatching(ProtocolCorrespondenceType.class, values);
