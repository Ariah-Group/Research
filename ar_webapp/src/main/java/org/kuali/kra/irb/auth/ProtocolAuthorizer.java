...
/**
 * A Protocol Authorizer determines if a user can perform a given task on a
 * protocol.
 */
public abstract class ProtocolAuthorizer extends ProtocolAuthorizerBase {
    ...
    /**
     * Find the submission. It is the submission that is either currently
     * pending or already submitted to a committee.
     *
     * @param protocol
     * @return
     */
    ...
    /**
     * Find the submission. It is the submission that is either currently
     * pending or already submitted to a committee, or is in agenda.
     *
     * @param protocol
     * @return
     */
    ...
    /**
     * Find the submission. It is the submission that is either currently
     * pending or already submitted to a committee, or is in agenda if the
     * includeInAgenda parameter is set.
     *
     * @param protocol
     * @return
     */
     ...
     *
     * @param protocol
     * @return true when the protocol submission type is request for suspension;
     * otherwise false
     */
    ...
    protected boolean canPerformActionOnExpeditedOrExempt(ProtocolSubmission lastSubmission, ProtocolAction lastAction) {
        ...
        if (isSubmissionValidForAction(lastSubmission)) {
            canPerform = isExpeditedOrExempt(lastSubmission.getProtocolReviewType().getReviewTypeCode());
        }
        return canPerform;
    }
