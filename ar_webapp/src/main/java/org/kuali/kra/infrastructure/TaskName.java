...
public interface TaskName {
    ...
    */
    ...
    public static final String CREATE_PROTOCOL_AMENDMENT = "createAmendment";
    public static final String CREATE_PROTOCOL_AMENDMENT_UNAVAILABLE = "createAmendmentUnavailable";
    public static final String MODIFY_PROTOCOL_AMENDMENT_SECTIONS = "modifyAmendmentSections";
    public static final String MODIFY_PROTOCOL_AMENDMENT_SECTIONS_UNAVAILABLE = "modifyAmendmentSectionsUnavailable";
