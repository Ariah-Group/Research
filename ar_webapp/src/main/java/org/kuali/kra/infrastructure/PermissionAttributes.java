...
public class PermissionAttributes {
    ...
    private static final String DOC_ACTION_CREATE_AMENDMENT = "create_amendment";
    ...
    static {
        ...
        attributes = new HashMap<String, String>();
        attributes.put(ATTR_DOCUMENT_TYPE_NAME, DOC_TYPE_PROTOCOL);
        attributes.put(ATTR_DOCUMENT_ACTION, DOC_ACTION_CREATE_AMENDMENT);
        tempAttributesMap.put(PermissionConstants.CREATE_AMENDMENT, attributes);
