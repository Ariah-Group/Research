...
/**
 * Implementation of
 * {@link ProtocolAttachmentService ProtocolNoteAndAttachmentService}.
 */
public abstract class ProtocolAttachmentServiceImplBase implements ProtocolAttachmentService {
     ...
     * {@inheritDoc}
     */
    public void saveAttachment(ProtocolAttachmentBase attachment) {
     ...
     * {@inheritDoc}
     */
    public void deleteAttachment(ProtocolAttachmentBase attachment) {
        if (attachment == null) {
            throw new IllegalArgumentException("the attachment is null");
        }
     ...
     *
     * @see
     * org.kuali.kra.protocol.noteattachment.ProtocolAttachmentService#isNewAttachmentVersion(org.kuali.kra.protocol.noteattachment.ProtocolAttachmentProtocolBase)
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Gets a "code" BO from a code. This method will only work for a BO that
     * has a property of "code" that is the primary key.
     *
     * @param <T> the BO type
     * @param type the type
     ...
     *
     * @see
     * org.kuali.kra.protocol.noteattachment.ProtocolAttachmentService#isSharedFile(org.kuali.kra.protocol.noteattachment.ProtocolAttachmentPersonnelBase)
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @see
     * org.kuali.kra.protocol.noteattachment.ProtocolAttachmentService#setProtocolAttachmentPersonnelUpdateUsersName(java.util.List)
     */
