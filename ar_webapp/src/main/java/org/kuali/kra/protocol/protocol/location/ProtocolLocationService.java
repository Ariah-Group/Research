...
public interface ProtocolLocationService {
    ...
    /**
     * This method adds a default ProtocolLocationBase to the List of
     * ProtocolLocations. i.e. Initialize protocol location with a default
     * organization
     *
     * @param protocol which contains list of ProtocolLocations.
     */
    ...
    /**
     * This method will clear ProtocolLocationBase address from the List at
     * specified position(lineNumber)
     *
     * @param protocol which contains list of ProtocolLocations
