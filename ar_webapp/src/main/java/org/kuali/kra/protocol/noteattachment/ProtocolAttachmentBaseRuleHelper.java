...
/**
 * This class contains methods to "help" in validating
 * {@link ProtocolAttachmentBase ProtocolAttachmentBase}.
 */
public abstract class ProtocolAttachmentBaseRuleHelper {
    ...
    /**
     * Creates helper deferring the setting of the prefix to later and setting
     * used services.
     *
     ...
     *
     * @param aPropertyPrefix the prefix (ex:
     * notesAttachmentsHelper.newAttachmentProtocol)
    ...
    /**
     * Checks for a valid description when description is required. Creates a
     * hard error.
     *
    ...
    public <T extends ProtocolAttachmentBase & TypedAttachment> boolean validDescriptionWhenRequired(final T attachment) {
        ...
        if (StringUtils.isBlank(attachment.getDescription()) && protocolAttachmentTypeCodeOther.equals(attachment.getType().getCode())) {
     ...
     *
     * <p>
     * This method does not validate the existence of a type code. This
     * validation is done by {@link #validType(ProtocolAttachmentBase)}. If the
     * type code is blank this method will return true.
     * </p>
     *
     * @param <T> the attachment "type"
     * @param attachment the attachment.
    ...
    /**
     * Validates that the selected file contains valid fields. Creates a hard
     * error.
     *
