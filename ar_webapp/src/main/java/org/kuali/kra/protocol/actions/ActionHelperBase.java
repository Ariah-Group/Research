...
public abstract class ActionHelperBase implements Serializable {
    ...
    /**
     * This method is to reinitialize amendment beans, otherwise a second pass
     * thru prepareView() will show same amendment creation options as previous
     * passes
     *
     * @throws Exception
     */
    ...
    /**
     * Create an Amendment Bean. The modules that can be selected depends upon
     * the current outstanding amendments. If a module is currently being
     * modified by a previous amendment, it cannot be modified by another
     * amendment. Once the previous amendment has completed (approved,
     * disapproved, etc), then a new amendment can modify the same module.
     *
     * @return
     * @throws Exception
     */
    ...
    /**
     * Create an AdminCorrection Bean. The modules that can be edited (or
     * corrected) depends upon the current outstanding amendments. If a module
     * is currently being modified by a an amendment, it cannot be corrected
    ...
    /**
     *
     * This method is one of the criteria to decide if there is a followup
     * action for requested action panel to open
     *
     * @return
     */
    ...
    public ProtocolActionBase getLastPerformedAction() {
        ...
        return protocolActions.isEmpty() ? null : protocolActions.get(0);
    }
...
//            }
    ...
    /**
     * Finds and returns the current selection based on the
     * currentSubmissionNumber.
     *
     * If the currentSubmissionNumber is invalid, it will return the current
     * protocol's latest submission (which is always non-null); otherwise, it
     * will get the submission from the protocol based on the
     * currentSubmissionNumber.
     *
    ...
    /**
     *
     * This method is to get previous submission number. Current implementation
     * is based on submission number in sequence. If multiple amendment/renewal
     * are submitted, but approved not according to submission order. Then we
     * may have gaping submission number.
     *
     * @return
     */
    ...
    /**
     *
     * This method determines whether the committee select list should be
     * displayed or not.
     *
     * @return
     */
     ...
     *
     * @param protocolSummaryPrintOptions The protocolSummaryPrintOptions to
     * set.
     */
    ...
    /**
     * This method copies the settings from the ProtocolAmendRenewalBase bo to
     * the amendmentBean and enables the corresponding modules. Set appropriate
     * details in subclass
     *
     * @param amendmentBean
     ...
     * enabled flag to true in the amendment bean. Set appropriate details in
    ...
    /**
     * Enable module option while populating the protocolAmendmentBean with the
     * amendment details from the current submission. Set appropriate details in
     * subclass
     *
     * @param amendmentBean
    ...
    /**
     *
     * This method returns the number of years to add for the default expiration
     * date.
     *
     * @return
     */
