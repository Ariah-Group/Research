...
public class SubAward extends KraPersistableBusinessObjectBase
    ...
    public List<SubAwardAmountReleased> getSubAwardAmountReleasedList() {
        ...
        return (List<SubAwardAmountReleased>) KraServiceLocator.getService(BusinessObjectService.class).findMatchingOrderBy(SubAwardAmountReleased.class, values, "createdDate", false);
    }
