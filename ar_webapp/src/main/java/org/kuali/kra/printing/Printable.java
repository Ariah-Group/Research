 ...
 * in the system. Docs & BOs that will be printed via printing services should
...
public interface Printable extends Serializable {
    ...
    /**
     *
     * This method returns whether to enable or disable watermark in the report.
     *
    ...
    /**
     *
     * This method for setting the appropriate watermark with respect to the
     * document.
     *
