...
public class InstitutionalProposalServiceImpl implements InstitutionalProposalService {
    ...
    /**
     * Creates a new pending Institutional Proposal based on given development
     * proposal and budget.
     *
     ...
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#createInstitutionalProposal(DevelopmentProposal,
     * Budget)
     */
    ...
    /**
     * Creates a new active version of the Institutional Proposal corresponding
     * to the given proposal number, with data copied from the given development
     * proposal and budget.
     *
     ...
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#createInstitutionalProposalVersion(String,
     ...
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#getInstitutionalProposal(String)
     */
     ...
     * Note, PENDING here refers to the Version Status, NOT the Proposal Status
     * of the Institutional Proposal.
     *
     * This is just a pass-through to InstitutionalProposalVersioningService,
     * but we needed this method to be part of the module API.
     *
     * @param proposalNumber String
     ...
     * Note, ACTIVE here refers to the Version Status, NOT the Proposal Status
     * of the Institutional Proposal.
     *
     * @param proposalNumber String
     ...
     *
     * If the given Proposal has a Proposal Status of Pending, a new Final
     * version of the Proposal will be created with a Proposal Status of Funded.
     *
     ...
     *
     * If the given Award was the only funding Award for a Proposal, a new Final
     * version of the Proposal will be created with a Proposal Status of
     * Pending.
     *
     * If the Proposal has other funding Awards, it will be left alone. It will
     * also be left alone if it is funded by the active version of the given
     * award number (this is a functional requirement).
     *
     * @param proposalNumbers The proposals to update.
     ...
     *
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#getProposalForProposalNumber(java.lang.String)
     */
    ...
    /**
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#getAllLinkedDevelopmentProposals(java.lang.String)
     */
    ...
    /**
     * Queries the persistence layer to find the InstitutionalProposal record
    ...
    protected void doBaseFieldsDataFeed(InstitutionalProposal institutionalProposal, DevelopmentProposal developmentProposal) {
        ...
        institutionalProposal.setAwardTypeCode(developmentProposal.getAnticipatedAwardTypeCode());
    ...
    /**
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#createAndSaveNewVersion(org.kuali.kra.institutionalproposal.home.InstitutionalProposal,
    ...
    /**
     * This method is to synch custom attributes. During version process only
    ...
    /**
     * @see
     * org.kuali.kra.institutionalproposal.service.InstitutionalProposalService#getValidFundingProposalStatusCodes()
     */
    @Override
    public Collection<String> getValidFundingProposalStatusCodes() {
        String value = getParameterService().getParameterValueAsString(Constants.MODULE_NAMESPACE_INSTITUTIONAL_PROPOSAL,
                Constants.PARAMETER_COMPONENT_DOCUMENT, "validFundingProposalStatusCodes");
