...
/**
 *
 * This class is to override 'create new' url. MODIFY_QUESTIONNAIRE permission
 * is need for this url.
 */
public class QuestionnaireLookupableImpl extends KualiLookupableImpl {
    ...
    /**
     * new url is redirect to "maintenanceQn", and also need to have
     * MODIFY_QUESTIONNAIRE permission.
     *
