...
public class QuestionMaintenanceForm extends KualiMaintenanceForm {
    ...
    /**
     * This method disables the caching of drop down lists. Question maintenance
     * has a drop down list whose value depends on another drop down list. With
    ...
    /**
     * override this for view bootstrap data. A new doc is initiated in this
     * case. this will make the document header looks 'Final'.
     *
     * @see
