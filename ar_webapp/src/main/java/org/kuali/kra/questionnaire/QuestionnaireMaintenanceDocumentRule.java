...
/**
 *
 * This class is to provide rule validation when questionnaire is to be
 * approved.
 */
public class QuestionnaireMaintenanceDocumentRule extends MaintenanceDocumentRuleBase {
    ...
    /**
     *
     * This method to check whether if the required fields are ok and whether
     * name exists.
     *
        ...
        for (QuestionnaireQuestion questionnaireQuestion : newQuestionnaire.getQuestionnaireQuestions()) {
            if ((questionnaireQuestion.getQuestion() != null) && ("I".equals(questionnaireQuestion.getQuestion().getStatus()))) {
                errorMap.putError("document.newMaintainableObject.businessObject.question"
                        + newQuestionnaire.getQuestionnaireQuestions().indexOf(questionnaireQuestion), KeyConstants.ERROR_QUESTIONNAIRE_QUESTION_INACTIVE, questionnaireQuestion.getQuestion().getQuestion());
                valid = false;
            }
        }
    ...
    /**
     *
     * This method determines if the passed in sequence number is the latest
     * sequence for the passed in questionnaireId.
     *
