...
/**
 *
 * This class defines the methods for questionnaire answer page. These methods
 * should be module independent.
 */
public interface QuestionnaireAnswerService {
    ...
    /**
     *
     * This method is to get existing questionnaire answer or set up the
     * associate questionnaire answer for the module keys specified in
    ...
    /**
     *
     * This method to create new questionnaire answer header for the new version
     * questionnaire if user selected not to copy answers from old version.
     *
     * @param moduleQuestionnaireBean
     * @param questionnaire
     * @return
    ...
    /**
     *
     * This method is to copy questionnaire from old protocol to the new
     * protocol version.
     *
     * @param moduleQuestionnaireBean
     * @return
    ...
    /**
     *
     * This method is move answer for multiple answer question if needed and
     * also update 'completed' flag.
     *
     * @param answerHeaders
     */
    ...
    /**
     *
     * This method update whether a child question is going to be displayed or
     * hidden based on parent's answer and condition. This method is public is
    ...
    /**
     * check if the questionnaire is complete. This method...
     *
     * @param answers
     * @return
     */
     ...
     * ModuleQuestionnaire Bean. This method persists the new AnswerHeader
     * objects it creates.
     *
     * @param srcModuleQuestionnaireBean the ModulQuestionnaireBean containing
     * the data pointing to the source questionnaires.
     * @param newModuleQuestionnaireBean the ModuleQuestionnaireBean you would
     * like to copy the AnswerHeader objects to.
     *
     ...
     * Questionnaire answer may contain submit questionnaire, request submission
     * questionnaire, amendment/renewal questionnaire.
     *
    ...
    /**
     * This method checks if the latest questionnaire instance associated with
     * the given questionnaire ID is active and that it has the given module and
    ...
    /**
     * Based on the data in the answer header, rebuild the module specific
     * ModuleQuestionnaireBean. Assumes the document is in a final state.
     *
     * @param answerHeader
     * @return
     */
    ...
    /**
     * Based on the moduleItemCode and moduleSubItemCode rebuilds the module
     * specific ModuleQuestionnaireBean.
     *
    ...
    /**
     *
     * This method is to get a new version of existing questionnaire answer or
     * set up the associate questionnaire answer for the module keys specified
     * in ModuleQuestionnaireBean.
     *
     * @param moduleQuestionnaireBean
     * @return
     */
    ...
    /**
     *
     * This method is to get all the questionnaire answers to print for the
     * protocol. This method is intended to obtain the data that will ultimately
     * be used by the protocol actions, print, questionnaire sub-tab.
     *
     * @param moduleQuestionnaireBean
     * @param protocolNumber
     * @param questionnaireHelper
