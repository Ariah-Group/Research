...
/**
 * Class for generating the XML object for grants.gov GGLobbyingFormV1_1. Form
 * is generated using XMLBean classes and is based on GGLobbyingForm schema.
 *
...
public class GGLobbyingFormV1_1Generator extends GGLobbyingFormBaseGenerator {
    ...
    /**
     *
     * This method is used to get Lobbying form information such as Applicant
     * Name, Authorized Representative Title,Name,Signature,SubmittedDate.
     *
     * @return lobbyingFormDocument(LobbyingFormDocument) {@link XmlObject} of
     * type LobbyingFormDocument.
     */
     ...
     * {@link LobbyingFormDocument} by populating data from the given
