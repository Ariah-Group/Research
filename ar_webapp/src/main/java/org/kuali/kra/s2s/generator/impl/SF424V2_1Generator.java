...
/**
 * This Class is used to generate XML object for grants.gov SF424V2.1. This form
 * is generated using XMLBean classes and is based on SF424-V2.1 schema.
 *
...
public class SF424V2_1Generator extends SF424BaseGenerator {
    ...
    /**
     *
     * This method returns SF42421Document object based on proposal development
     * document which contains the SF42421Document information for a particular
     * proposal
     *
    ...
    /**
     *
     * This method gets SF42421 information for the form which includes
    ...
    private SF42421 getSF42421() {
        ...
        if (divisionName != null) {
            if (divisionName.length() > DEPARTMENT_NAME_MAX_LENGTH) {
                sf424V21.setDivisionName(departmentName.substring(0, DEPARTMENT_NAME_MAX_LENGTH));
            }
        }
