...
/**
 *
 * This class is used to generate XML Document object for grants.gov CD511V1.1.
 * This form is generated using XMLBean API's generated by compiling CD511V1_1
 * schema.
 *
...
public class CD511V1_1Generator extends S2SBaseFormGenerator {
    ...
    /**
     *
     * This method returns CD511Document object based on proposal development
     * document which contains the CD511Document informations
     * OrganizationName,AwardNumber,ProjectName,ContactName,Title,Signature,SubmittedDate
     * for a particular proposal
     *
     * @return cd511Document(CD511Document){@link XmlObject} of type
     * CD511Document.
     */
    ...
    /**
     * This method creates {@link XmlObject} of type {@link CD511Document} by
