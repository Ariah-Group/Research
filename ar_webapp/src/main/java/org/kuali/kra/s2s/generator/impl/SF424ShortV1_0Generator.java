 ...
 * form is generated using XMLBean classes and is based on SF424Short-V1.0
 * schema.
 *
...
//        }
     ...
     *
     * @param index (int)
     * @return appTypeCodeDataType(ApplicantTypeCodeDataType.Enum) applicant
     * type corresponding to the applicant type code.
     */
    ...
    /**
     * This method creates {@link XmlObject} of type {@link SF424ShortDocument}
