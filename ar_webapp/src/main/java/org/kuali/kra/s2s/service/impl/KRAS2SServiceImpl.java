...
public class KRAS2SServiceImpl implements S2SService {
     ...
     * @throws S2SException
     * @see
     * org.kuali.kra.s2s.service.S2SService#getStatusDetails(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * @see
     * org.kuali.kra.s2s.service.S2SService#parseOpportunityForms(org.kuali.kra.s2s.bo.S2sOpportunity)
     */
    @Override
     ...
     * @throws S2SException
     * @see
     * org.kuali.kra.s2s.service.S2SService#refreshGrantsGov(org.kuali.kra.proposaldevelopment.document.ProposalDevelopmentDocument)
     */
    @Override
    ...
    public GetApplicationListResponse fetchApplicationListResponse(ProposalDevelopmentDocument pdDoc) throws S2SException {
        ...
        S2sOpportunity s2sOpportunity = (S2sOpportunity) businessObjectService.findByPrimaryKey(S2sOpportunity.class, opportunityMap);
        ...
        GetApplicationListResponse applicationListResponse = getS2sConnectorService(s2sOpportunity)
                .getApplicationList(s2sOpportunity.getOpportunityId(),
                        s2sOpportunity.getCfdaNumber(), s2sOpportunity.getProposalNumber());
     ...
     * @param applicationListResponse {@link GetApplicationListResponse}
     * response from Grants Gov
     * @throws S2SException
     */
    protected void saveGrantsGovStatus(ProposalDevelopmentDocument pdDoc,
        ...
        if (appSubmission != null) {
            ...
            if (applicationListResponse.getApplicationInfo() == null || applicationListResponse.getApplicationInfo().size() == 0) {
                ...
                ApplicationInfo ggApplication = applicationListResponse.getApplicationInfo().get(appSize - 1);
    ...
    public void populateAppSubmission(ProposalDevelopmentDocument pdDoc, S2sAppSubmission appSubmission,
        ...
        appSubmission.setReceivedDate(new Timestamp(ggApplication
    ...
    /**
     * @see
     * org.kuali.kra.s2s.service.S2SService#populateSponsorProposalId(org.kuali.kra.proposaldevelopment.document.ProposalDevelopmentDocument,
     * org.kuali.kra.s2s.bo.S2sAppSubmission)
     */
    @Override
     ...
     * @throws S2SException
     * @see
     * org.kuali.kra.s2s.service.S2SService#searchOpportunity(java.lang.String,
     ...
     * @throws S2SException
     * @see
     * org.kuali.kra.s2s.service.S2SService#submitApplication(org.kuali.kra.proposaldevelopment.document.ProposalDevelopmentDocument)
     */
    @Override
     ...
     * @param appSubmission {@link S2sAppSubmission} submission details of
     * proposal
     * @param response {@link SubmitApplicationResponse} submission response
     * from grants gov
     * @param grantApplicationXml {@link String} XML content of submission
     * @param s2sAppAttachmentList {@link S2sAppAttachments} attachments
...
//			saveList.add(application);
     ...
     * @throws S2SException
     * @see
     * org.kuali.kra.s2s.service.S2SService#validateApplication(org.kuali.kra.proposaldevelopment.document.ProposalDevelopmentDocument)
     */
    @Override
    ...
    /**
     * This method convert GetOpportunityListResponse to
     * ArrayList<OpportunityInfo>
     *
