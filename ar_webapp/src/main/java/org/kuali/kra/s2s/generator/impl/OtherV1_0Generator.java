...
/**
 * Class for generating the XML object for grants.gov OtherV1_0. Form is
 * generated using XMLBean classes and is based on OtherV1_0 schema.
 *
...
public class OtherV1_0Generator extends OtherBaseGenerator {
     ...
     * {@link OtherNarrativeAttachmentsDocument} by populating data from the
