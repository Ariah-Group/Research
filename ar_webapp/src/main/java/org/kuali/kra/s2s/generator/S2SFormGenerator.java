...
/**
 *
 * This interface defines the core methods for the Form Generator classes and is
 * meant to be implemented by all generators
 *
...
public interface S2SFormGenerator {
    ...
    /**
     *
     * This method creates an XML document using the APIs generated using
     * XMLBEans by compiling the form's schema and returns it as XmlObject.
     *
