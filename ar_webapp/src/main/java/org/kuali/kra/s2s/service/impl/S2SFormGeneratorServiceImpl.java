...
/**
 *
 * This class is used as a service implementation that is used to create
 * instances of opportunity form generator classes. It provides an abstraction
 * level over the different generator class implementations.
 *
...
public class S2SFormGeneratorServiceImpl implements S2SFormGeneratorService {
    ...
    /**
     *
     * This method is used to create and return a form generator instance. Based
     * on the namespace provided as parameter, it instantiates the respective
     * generator class and returns it.
     *
     * @param nameSpace name space of the generator.
     * @return S2SFormGenerator form generator instances corresponding to the
     * name space.
     * @throws S2SException if generator could not be loaded
     * @throws S2SGeneratorNotFoundException if form generator for given
