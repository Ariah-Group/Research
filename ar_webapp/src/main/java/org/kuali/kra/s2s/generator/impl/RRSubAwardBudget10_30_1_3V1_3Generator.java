...
import gov.grants.apply.forms.rrSubawardBudget103013V13.RRSubawardBudget103013Document;
import gov.grants.apply.forms.rrSubawardBudget103013V13.RRSubawardBudget103013Document.RRSubawardBudget103013;
import gov.grants.apply.forms.rrSubawardBudget103013V13.RRSubawardBudget103013Document.RRSubawardBudget103013.BudgetAttachments;
 ...
 */
public class RRSubAwardBudget10_30_1_3V1_3Generator extends S2SAdobeFormAttachmentBaseGenerator {

    private static final String RR_BUDGET10_13_NAMESPACE_URI = "http://apply.grants.gov/forms/RR_Budget10_1_3-V1.3";
    private static final String RR_BUDGET10_13_LOCAL_NAME = "RR_Budget10_1_3";
     ...
     */
    private RRSubawardBudget103013Document getRRSubawardBudgetDocument() {

        RRSubawardBudget103013Document rrSubawardBudgetDocument = RRSubawardBudget103013Document.Factory.newInstance();
        RRSubawardBudget103013 rrSubawardBudget = RRSubawardBudget103013.Factory.newInstance();
        BudgetAttachments budgetAttachments = BudgetAttachments.Factory.newInstance();
        List<BudgetSubAwards> budgetSubAwardsList = getBudgetSubAwards(pdDoc, RR_BUDGET10_13_NAMESPACE_URI, false);
        ...
        for (BudgetSubAwards budgetSubAwards : budgetSubAwardsList) {
            RRBudget1013 rrBudget = getRRBudget1013(budgetSubAwards).getRRBudget1013();
            switch (attCount) {
                case 1:
        ...
        rrSubawardBudgetDocument.setRRSubawardBudget103013(rrSubawardBudget);
     ...
     */
    private RRBudget1013Document getRRBudget1013(BudgetSubAwards budgetSubAwards) {
