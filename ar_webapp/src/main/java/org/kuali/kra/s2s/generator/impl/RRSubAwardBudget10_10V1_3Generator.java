...
/**
 * Class for generating the XML object for grants.gov RR_SubawardBudget10_10_1_3
 * Form is generated using XMLBean classes and is based on RRSubAwardBudget
 * schema.
 *
...
public class RRSubAwardBudget10_10V1_3Generator extends S2SAdobeFormAttachmentBaseGenerator {
    ...
    private RRSubawardBudget101013Document getRRSubawardBudgetDocument() {
        ...
        List<BudgetSubAwards> budgetSubAwardsList = getBudgetSubAwards(pdDoc, RR_BUDGET_10_1_3_NAMESPACE_URI, false);
     ...
     */
    private RRBudget1013Document getRRBudget(BudgetSubAwards budgetSubAwards) {
