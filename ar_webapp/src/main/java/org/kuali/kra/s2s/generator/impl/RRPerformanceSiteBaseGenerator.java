...
public abstract class RRPerformanceSiteBaseGenerator extends S2SBaseFormGenerator {
    ...
    /**
     *
     * This method checks the string value passed and returns empty string if it
     * is null, else returns string value
     *
     * @param string (String) string to be checked for null.
     * @return string (String) empty string if sting value is null else string
     * value.
     */
