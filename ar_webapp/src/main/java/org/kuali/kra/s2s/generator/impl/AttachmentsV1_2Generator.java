...
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT1;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT10;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT11;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT12;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT13;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT14;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT15;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT2;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT3;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT4;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT5;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT6;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT7;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT8;
import gov.grants.apply.forms.attachmentForm12V12.AttachmentsDocument.Attachments.ATT9;
 ...
 * AttachmentsV1.2. This form is generated using XMLBean API's generated by
 * compiling AttachmentsV1.2 schema.
 *
 */
public class AttachmentsV1_2Generator extends S2SBaseFormGenerator {

    private static final int NARRATIVECODE_ATTACHMENTS = 61;

    /**
     *
     * This method returns the Other type attachments based on the narrative
     * type code. It gets the attachment if the narrative type code is
     * 8(narrative type code for Other type)
     *
     * @return attachmentsDocument(AttachmentsDocument) {@link XmlObject} of
     * type AttachmentsDocument.
     */
    private AttachmentsDocument getAttachment() {
        ...
        attachments.setFormVersion(S2SConstants.FORMVERSION_1_2);
    ...
    /**
     * This method creates {@link XmlObject} of type {@link AttachmentsDocument}
