...
public interface KcAttachmentService {
    ...
    /**
     * Based on the attachment provided determine and return a path to the icon
     * for the file.
     *
     * @param attachment
     * @return
    ...
    /**
     * This method checks for invalid characters in strings and replaces them
     * with underscores.
     *
     * @param text
     * @return
    ...
    /**
     * This method checks for special characters in strings and replaces them
     * with underscores.
     *
     * @param text
     * @return
