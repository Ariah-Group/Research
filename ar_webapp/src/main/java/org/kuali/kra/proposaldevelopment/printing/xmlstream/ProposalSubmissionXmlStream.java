...
public class ProposalSubmissionXmlStream extends ProposalBaseStream {
     ...
     */
    private PROPOSALMASTER getProposalMaster(DevelopmentProposal developmentProposal, Budget budget) {
        ...
        if (proposalSite!=null && proposalSite.getRolodex() != null) {
            proposalMaster.setORGANIZATION(getDevelopmentProposalOrganizationXMLObject(proposalSite.getRolodex()));
        ...
        proposalMaster.setCOI(getConflictOfInterest(developmentProposal.getProposalChangedDataList()));
        proposalMaster.setDEADLINE(getSponsorDeadLine(developmentProposal.getDeadlineDate(), developmentProposal.getDeadlineType()));
        ...
        proposalMaster.setNOTICEOFOPPORTUNITY(getNoticeOfOpportunityXMLObject(developmentProposal
        ...
        proposalMaster.setMAILTYPE(getMailType(developmentProposal.getMailType()));
    ...
    private String getPersonNameAndInfo(KcPerson person) {
        ...
        if (personEmail != null && officePhone != null) {
            personInfo = new StringBuilder(OPEN_BRACES).append(
                    personEmail).append(officePhone)
                    .append(CLOSE_BRACES).toString();
        }
        if (personEmail == null && officePhone != null) {
            personInfo = new StringBuilder(OPEN_BRACES).append(
                    officePhone).append(CLOSE_BRACES).toString();
        }
