...
public class ProposalDevelopmentKeyPersonsRule extends ResearchDocumentRuleBase implements AddKeyPersonRule, ChangeKeyPersonRule, CalculateCreditSplitRule {
    ...
    /**
     * @see
     * ResearchDocumentRuleBase#processCustomSaveDocumentBusinessRules(Document)
     */
    @Override
     ...
     * <li>A person cannot have multiple roles, ie. a person can only be added
     * as a key person once.</li>
     * </ul>
     *
     * @see
     * org.kuali.kra.proposaldevelopment.rule.AddKeyPersonRule#processAddKeyPersonBusinessRules(ProposalDevelopmentDocument,ProposalPerson)
     */
    @Override
     ...
     *
     * @see
     * org.kuali.kra.proposaldevelopment.rule.ChangeKeyPersonRule#processChangeKeyPersonBusinessRules(org.kuali.kra.proposaldevelopment.bo.ProposalPerson,
     * org.kuali.rice.krad.bo.BusinessObject)
     * @see
     * org.kuali.kra.proposaldevelopment.web.struts.action.ProposalDevelopmentKeyPersonnelAction#insertDegree(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     * @see
     * org.kuali.kra.proposaldevelopment.web.struts.action.ProposalDevelopmentKeyPersonnelAction#insertUnit(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     */
    ...
    /**
     * Checks to makes sure that the unit is valid. Usually called as a result
     * of a <code>{@link ProposalPersonUnit}</code> being added to a
    ...
    /**
     * Determine whether the <code>{@link ProposalPersonUnit}</code> already
     * exists by Unit Number in the given <code>{@link ProposalPerson}</code>
     *
     * @param source
     * @param person
    ...
    /**
     * Checks to makes sure that the degree is valid. Usually called as a result
     * of a <code>{@link ProposalPersonDegree}</code> being added to a
     * <code>{@link ProposalPerson}</code>.
     *
     * @param source
     * @return boolean
