...
/**
 * Business Rule to determine the legality of modifying the access to a Proposal
...
public class ProposalDevelopmentPermissionsRule extends ResearchDocumentRuleBase implements PermissionsRule {
    ...
    /**
     * This method tests if the user is the only user with modify narrative
     * rights for the narrative
     *
     * @param username the user
     * @param narrative the narrative
     * @return true if the user is the only one with modify rights for the
     * narrative
     */
    ...
    /**
     * This method tests if the user is having modify narrative permissions
     * removed. It does this by seeing if the user in the ProposalUserEditRoles
     * has modify narrative permissions in ProposalUserEditRoles but not in the
     * list of ProposalUserRoles.
     *
     ...
     * @return true if the user has modify narrative permissions in the list but
     * not in the ProposalUserEditRoles
     */
    ...
    /**
     * This method checks if the user has Modify Narrative permission in the
     * passed list of ProposalUserRoles
     *
     * @param username the user
     * @param proposalUserRolesList the list of ProposalUserRoles to check
     * @return true if the user has Modify Narrative permissions in the list of
     * ProposalUserRoles
     */
     ...
     *
     * @param editRoles the Proposal Edit Roles
     * @return true if a role other than Aggregator has been selected; otherwise
     * false
     */
    ...
    /**
     * Is this a duplicate user? In other words, has this user already been
     * added to the list of users who can access the proposal?
     *
