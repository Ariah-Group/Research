...
public class KeyPersonnelAuditRule extends ResearchDocumentRuleBase implements DocumentAuditRule {
    ...
    public boolean processRunAuditBusinessRules(Document document) {
        ...
        for (ProposalPerson person : pd.getDevelopmentProposal().getProposalPersons()) {
            ...
            if (pd.getDevelopmentProposal().getSponsor() != null) {
                isSponsorMultiPi = pd.getDevelopmentProposal().getSponsor().isMultiplePi();
            }
    ...
    /**
     *
     * @param person <code>{@link ProposalPerson}</code> instance that is also
     * an investigator to validate
    ...
    /**
     *
     * @param person <code>{@link ProposalPerson}</code> instance who's units we
     * want to validate
    ...
    /**
     * Convenience method for creating a <code>{@link SimpleEntry}</code> out of
     * a key/value pair
     *
     * @param key
     * @param value
