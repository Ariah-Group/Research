...
/**
 * Implementation of business rules required for the Proposal attachment page of
 * the
...
public class ProposalDevelopmentNarrativeRule extends ResearchDocumentRuleBase implements AddNarrativeRule, ReplaceNarrativeRule, SaveNarrativesRule, NewNarrativeUserRightsRule {
    ...
    /**
     * This method is used to validate narratives and institute proposal
     * attachments before adding. It checks whether the narratives are
     * duplicated for those of which have allowMultiple flag set as false.
     *
     * @see
     * org.kuali.kra.proposaldevelopment.rule.AddNarrativeRule#processAddNarrativeBusinessRules(org.kuali.kra.proposaldevelopment.rule.event.AddNarrativeEvent)
     */
    ...
    /**
     * This method is used to validate narratives and institute proposal
     * attachments before saving. It checks whether the narratives are
     * duplicated for those of which have allowMultiple flag set as false.
     *
     * @see
     * org.kuali.kra.proposaldevelopment.rule.SaveNarrativesRule#processSaveNarrativesBusinessRules(org.kuali.kra.proposaldevelopment.rule.event.SaveNarrativesEvent)
     */
    ...
    /**
     * This method is used to validate characters in the attachment file name,
     * and should be invoked when a user attempts to replace a narrative
     * post-route.
     *
     * @see
     * org.kuali.kra.proposaldevelopment.rule.ReplaceNarrativeRule#processReplaceNarrativeBusinessRules(org.kuali.kra.proposaldevelopment.rule.event.ReplaceNarrativeEvent)
     */
    ...
    /**
     * Check to see if the user modified a narrative and verify that the user
     * has the necessary permission to make that modification.
     *
    ...
    /**
     * Find the narrative that matches the original narrative. A match occurs if
     * they have the same module number.
     *
    ...
    /**
     * It checks for duplicate narrative types and mandatory description for
     * narrative type 'Other' This method...
     *
     * @param narrativeList
     * @param narrative
     ...
     * @return true if at least one user has this narrative right; otherwise
     * false
     */
    ...
    /**
     * Does this person have the necessary permission for the narrative right
     * they have been assigned? In other words, a person cannot be given the
     * narrative right of modify if they don't have the MODIFY_NARRATIVE
     * permssion.
     *
