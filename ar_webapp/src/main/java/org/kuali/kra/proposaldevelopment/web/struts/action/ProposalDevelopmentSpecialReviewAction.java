...
public class ProposalDevelopmentSpecialReviewAction extends ProposalDevelopmentAction {
    ...
    /**
     * Adds a special review item. The add only completes if the special review
     * to be added passes all audit rules.
     *
    ...
    /**
     * Displays the Protocol linked to the special review item on the selected
     * line (from the parameter list since this is run through a popup window).
     *
     * @param mapping
     * @param form
     * @param request
