...
public class ProposalDevelopmentProposalAction extends ProposalDevelopmentAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if (proposalDevelopmentDocument.getDevelopmentProposal().getApplicantOrganization() != null
                ...
                && request.getParameter("methodToCall").equals("refresh")
...
//        }
    ...
    /**
     *
     * This method sets the flag for keyword display panel - display keyword
     * panel if parameter is set to true
     *
     * @param request
     */
    ...
    /**
     * This method checks rules on a new {@link ProposalSite} and sets the
     * proposal number.
     *
    ...
    /**
     * This method shows a delete confirmation page. If the user clicks "yes",
     * the selected Performance Site is deleted.
     *
    ...
    /**
     * This method shows a delete confirmation page. If the user clicks "yes",
     * the selected Other Organization is deleted.
     *
    ...
    /**
     * This method asks the user if they really want to delete a Proposal Site.
     * If the answer is "yes", <CODE>yesMethodName</CODE> is called.
     *
     * @param mapping
     * @param form
     * @param request
     ...
     * @param locationTypeName A descriptive name for the location type; used
     * for the confirmation question
     * @return
     * @throws Exception
     */
    ...
    /**
     * This method does the actual deletion of a Performance Site. It is called
    ...
    /**
     * This method does the actual deletion of a Other Organization. It is
    ...
    /**
     * This method returns the "site index" parameter from a
     * <CODE>request</CODE> if the <CODE>confirmationKey</CODE> matches the
     * current struts confirmation, and if it passes validation. Otherwise, -1
     * is returned.
     *
     * @param form
     * @param request
     * @param confirmationKey
     * @return The site index from the request, or -1 if the request contains no
     * valid site index.
     */
    ...
    /**
     * This method returns the "site index" parameter from a
     * <CODE>request</CODE> if the site index passes validation. Otherwise, -1
     * is returned.
     *
     * @param form
     * @param request
    ...
    /**
     * This method adds a congressional district to the n-th Performance Site,
     * where n is the "site" parameter of the methodToCall attribute.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This method adds a congressional district to the n-th Other Organization,
     * where n is the "site" parameter of the methodToCall attribute.
     *
     * @param mapping
     * @param form
    ...
    /**
     * This method asks the user whether they really want to delete the
     * district. If the answer is "yes", the delete action is called.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This method deletes a congressional district from the Applicant
     * Organization if a valid district index was supplied.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This method deletes a congressional district from the Performing
     * Organization if a valid district index was supplied.
     *
     * @param mapping
     * @param form
    ...
    /**
     * This method deletes a congressional district from one of the Performance
     * Sites if a valid district index was supplied.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This method deletes a congressional district from one of the Other
     * Organizations.
     *
     * @param mapping
     * @param form
    ...
    /**
     * This method deletes the districtIndexStr-th congressional district from
     * the siteIndexStr-th Proposal Site.
     *
     * @param mapping
     * @param proposalSites
...
//                }
    ...
    /**
     *
     * Begins the operation to Clear the Mailing Name and Address selected from
     * Delivery info panel. Now makes call to confirm the clear action before
     * executing.
     *
     * @param mapping
     * @param form
