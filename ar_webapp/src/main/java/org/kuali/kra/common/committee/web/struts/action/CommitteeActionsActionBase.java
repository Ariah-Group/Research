...
/**
 * The CommitteeActionsActionBase corresponds to the Actions tab (web page). It
 * is responsible for handling all user requests from that tab (web page).
 */
public abstract class CommitteeActionsActionBase extends CommitteeActionBase {
    ...
    /**
     * This method is perform the action - Generate Batch Correspondence. Method
     * is called in CommitteeActions.jsp
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     *
     * This method returns the selected batch correspondence that just have been
     * generated documents for viewing.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     *
     * This method returns the selected batch correspondence history documents
     * for viewing.
     *
     * @param mapping
     * @param form
    ...
    /**
     *
     * This method returns the selected batch correspondence documents for
     * viewing.
     *
     * @param mapping
     * @param form
     ...
     *
     * (This is a slimed down version of MergePdfBytes() in
     * PrintingServiceImpl.java)
     *
...
//              throw new PrintingException(e.getMessage(), e);
    ...
    /**
     * This method is perform the action - Print CommitteeBase Document. Method
     * is called in CommitteeActions.jsp
     *
     * @param mapping
     * @param form
