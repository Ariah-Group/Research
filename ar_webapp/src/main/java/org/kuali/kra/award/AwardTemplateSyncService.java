...
/**
 * This class is used for sync AwardSponsorTemplate details to different Award
 * Details Objects.
 */
public interface AwardTemplateSyncService {
     ...
     *
     * @param award
     * @param syncPropertyName is the name of member variable to represent
     * syncable list
    ...
    /**
     * Method checks if a scope sync will alter existing data within the award
     * when called with a specific scope.
     *
    ...
    /**
     * Method returns true if the award's award template contains data that
     * would be synchronized in the provided scope.
     *
     * @param awardDocument The award document to check.
     * @param scope The scope to check.
