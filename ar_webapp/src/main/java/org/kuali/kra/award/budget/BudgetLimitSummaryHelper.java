...
public class BudgetLimitSummaryHelper implements Serializable {
    ...
    /**
     * Returns a map of costelements by category type from both current and
     * previous budgets.
     *
     * @return
     */
    ...
    /**
     * Returns a unique set of personnel object codes from both current previous
     * budgets
     *
     * @return
     */
    ...
    /**
     * Returns a unique set of rate types for personnel found in both current
    ...
    /**
     * Return a map of personnel calculated expense totals for the current
     * budget.
     *
     * @return
     */
    ...
    /**
     * Returns a map of personnel calculated expense totals for the previous
     * budget.
     *
     * @return
     */
    ...
    /**
     * Returns a unique set of the combinded non-personnel calculated expense
     * ratetypes.
     *
     * @return
     */
    ...
    /**
     * Return the non-personnel calculated expense totals for the current
     * budget.
     *
     * @return
     */
    ...
    /**
     * Return the non-personnel calculated expense totals for the previous
     * budget.
     *
     * @return
     */
