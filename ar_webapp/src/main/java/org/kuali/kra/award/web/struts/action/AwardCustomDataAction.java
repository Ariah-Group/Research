...
/**
 *
 * This class represents the Struts Action for Custom Data
 * page(AwardCustomData.jsp)
 */
public class AwardCustomDataAction extends AwardAction {
    ...
    /**
     * There is the additional logic in save for custom data. there is not add
     * functionality in the custom data tab, so the form custom data is being
     * added to the award on save.
     *
     * @see
    ...
    /**
     * @see
     * org.kuali.kra.web.struts.action.KraTransactionalDocumentActionBase#postDocumentSave(org.kuali.core.web.struts.form.KualiDocumentFormBase)
     */
    @Override
