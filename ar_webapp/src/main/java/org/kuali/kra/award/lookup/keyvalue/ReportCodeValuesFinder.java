...
public class ReportCodeValuesFinder extends UifKeyValuesFinderBase {
    ...
    /**
     * Constructs the list of Reports. Each entry in the list is a &lt;key,
     * value&gt; pair, where the "key" is the unique report code and the "value"
     * is the textual description that is viewed by a user.
     *
    ...
    /**
     *
     * This method iterates through the validClassReportFrequency and puts the
     * valid ones in a set for another method to process. This method sets the
     * frequency code to null to make all the objects having same report class
     * code and report code but different frequency code to resemble same; as it
    ...
    protected List<KeyValue> getKeyValues(Set<String> uniqueValidClassReportFrequencies) {
        ...
        for (String reportCode : uniqueValidClassReportFrequencies) {
            ...
            String reportReportCode = validClassReportFrequency.getReportCode();
