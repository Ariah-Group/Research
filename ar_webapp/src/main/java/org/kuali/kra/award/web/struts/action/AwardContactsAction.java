...
public class AwardContactsAction extends AwardAction {
    ...
    /**
     * This method is called to reset the Lead Unit on the award if the lead
     * unit is changed on the PI.
     *
     * @param award
     */
    ...
    /**
     *
     * This method is to build the confirmation question for syncing unit
     * contacts.
     *
     * @param mapping
     * @param form
    ...
    /**
     * This is action called when sync the unit contacts is called from Award
     * Unit contacts tab.
     *
     * @param mapping
     * @param form
