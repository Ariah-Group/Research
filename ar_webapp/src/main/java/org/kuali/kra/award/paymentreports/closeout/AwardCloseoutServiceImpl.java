...
public class AwardCloseoutServiceImpl implements AwardCloseoutService {
    ...
    /**
     *
     * This method updates the due dates for Award Closeout static reports based
     * on allDueDatesAreEqual flag and by comparing the
     * dateCalculatedUsingFinalInvoiceDue with dateCalculatedUsingFrequency.
     *
    ...
    public void updateCloseoutDueDatesBeforeSave(Award award) {
        ...
        for (KeyValue kl : (new CloseoutReportTypeValuesFinder()).getKeyValues()) {
            closeoutReportTypeCode = kl.getKey();
