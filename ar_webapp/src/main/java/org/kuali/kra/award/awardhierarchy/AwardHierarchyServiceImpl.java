...
public class AwardHierarchyServiceImpl implements AwardHierarchyService {
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#copyAwardAsNewHierarchy(AwardHierarchy)
     */
    @Override
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#createBasicHierarchy(java.lang.String)
     */
    @Override
    ...
    /**
     * When we create a new child award that is not a copy of the parent, we
     * still need copy dates from parent to child.
     *
     * @param source
     * @param copy
     */
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#loadAwardHierarchy(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#getAwardHierarchy(java.lang.String,
     * java.util.List)
     */
    @Override
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#loadFullHierarchyFromAnyNode(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#loadPlaceholderDocument()
     */
    @Override
    ...
    /**
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#persistAwardHierarchy(org.kuali.kra.award.awardhierarchy.AwardHierarchy)
     */
    @Override
    ...
    /**
     * This method copies an Award to a new Award, sequence #1, with
     * newAwardNumber
     *
     * @param award
    ...
    protected void clearFilteredAttributes(Award newAward) {
        ...
        /**
         * per KRACOEUS-5448 portions of the payment and invoices sub panel
         * items should not be copied.
         */
     ...
     * @see
     * org.kuali.kra.award.awardhierarchy.AwardHierarchyService#populateAwardHierarchyNodes(java.util.Map,
     * java.util.Map)
     */
    @Override
