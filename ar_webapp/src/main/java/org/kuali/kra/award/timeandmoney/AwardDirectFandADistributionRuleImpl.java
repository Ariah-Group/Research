...
/**
 * This class contains all rule methods for actions on Award Direct F and A
 * Distribution tab.
 */
public class AwardDirectFandADistributionRuleImpl extends ResearchDocumentRuleBase implements AwardDirectFandADistributionRule {
    ...
    /**
     * @see
     * org.kuali.kra.award.timeandmoney.AwardDirectFandADistributionRule#processAwardDirectFandADistributionRuleBusinessRules
    ...
    /**
     * @see
     * org.kuali.kra.award.timeandmoney.AwardDirectFandADistributionRule#processAddAwardDirectFandADistributionRuleBusinessRules
     * (org.kuali.kra.award.timeandmoney.AwardDirectFandADistributionRuleEvent)
     */
    ...
    /**
     * This method tests for overlapping dates in existing
     * AwardDirectFandADistribution list on the Award.
     *
    ...
    /**
     * This method tests for break in date ranges of existing
     * AwardDirectFandADistribution list on the Award.
     *
     * @param awardDirectFandADistributions
     * @return
    ...
    private boolean doTotalAnticipatedAmountValidOnExistingDistribution(List<AwardDirectFandADistribution> thisAwardDirectFandADistributions, boolean hasTimeAndMoneyBeenSaved) {
        ...
        if (awardDirectFandADistributions.size() > 0) {
            KualiDecimal awardAnticipatedTotal = awardDirectFandADistributions.get(0).getAward().getAnticipatedTotal();
            for (AwardDirectFandADistribution awardDirectFandADistribution : thisAwardDirectFandADistributions) {
    ...
    /**
     * This method tests that the period start date is prior to the period end
     * date.
     *
     * @return
     */
    ...
    /**
     * This method tests that the target date range falls into an open date
     * range.
     *
     * @param awardDirectFandADistributions
     * @return
    ...
    boolean isTargetEndDatePriorToProjectEndDate(AwardDirectFandADistributionRuleEvent awardDirectFandADistributionRuleEvent) {
        ...
        Date projectEndDate = getAwardAmountInfoService().fetchAwardAmountInfoWithHighestTransactionId(awardDirectFandADistributionRuleEvent.getTimeAndMoneyDocument().getAward().getAwardAmountInfos()).getFinalExpirationDate();
        boolean valid = true;
     ...
     *
     * @param awardDirectFandADistributions The awardDirectFandADistributions to
     * set.
     */
