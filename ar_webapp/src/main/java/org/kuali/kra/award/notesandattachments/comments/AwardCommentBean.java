...
/**
 * This class contains comment helper fields and methods for form and action
 * classes
 */
public class AwardCommentBean implements Serializable {
     ...
     *
     * @param awardCommentScreenDisplayTypes The awardCommentScreenDisplayTypes
     * to set.
     */
    ...
    public void setAwardCommentHistoryFlags() {
        ...
        for (AwardComment comment : comments) {
            results.add(allAwardCommentTypes.contains(comment.getCommentTypeCode()));
        }
