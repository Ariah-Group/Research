...
public class AwardSponsorTermRuleImpl extends ResearchDocumentRuleBase implements AwardSponsorTermRule {
    ...
    /**
     * @see
     * org.kuali.kra.award.AwardSponsorTermRule#processSponsorTermBusinessRules
    ...
    /**
     * @see
     * org.kuali.kra.award.rule.AwardSponsorTermRule#processSponsorTermBusinessRules
    ...
    /**
     * This method reports an error if sponsorTermCode is null (which means the
     * user didn't select a sponsor term).
     *
    ...
    /**
     * This method reports an error if sponsorTerm is null (which means the user
     * entered an invalid sponsor term code).
     *
     * @param sponsorTerm
