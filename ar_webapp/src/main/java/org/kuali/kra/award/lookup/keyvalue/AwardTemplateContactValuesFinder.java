...
public class AwardTemplateContactValuesFinder extends FormViewAwareUifKeyValuesFinderBase {
    ...
    /**
     *
     * @return the list of &lt;key, value&gt; pairs of the current award
     * template contacts id and roleCode
    ...
    public List<KeyValue> getKeyValues() {
        ...
        for (Iterator iter = contacts.iterator(); iter.hasNext();) {
            ...
            StringBuilder sb = new StringBuilder(contact.getContactType().getDescription());
