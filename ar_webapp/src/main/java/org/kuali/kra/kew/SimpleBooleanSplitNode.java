...
public class SimpleBooleanSplitNode implements SplitNode {
    ...
    /**
     * This method will look up the document being routed, if it is an instance
     * of ResearchDocumentBase it will call answerSplitNodeQuestion on it
     * passing the name of the route node. The default implementation
     * (currently) throws an UnsupportedOperationException for any input. If one
     * wishes to support the SplitNode for a given document, the method should
     * be overridden and return boolean T/F based on which of the branches (
     * always names "True" and "False" ) KEW should route to based upon the name
     * of the split node.
     *
     * @see
     * org.kuali.rice.kew.engine.node.SimpleNode#process(org.kuali.rice.kew.engine.RouteContext,
    ...
    /**
     * Converts a boolean value to SplitResult where the branch name is "True"
     * or "False" based on the value of the given boolean
     *
