...
public class IacucPersonTrainingMaintenanceDocumentAuthorizer extends MaintenanceDocumentAuthorizerBase {
    ...
    public boolean canInitiate(String documentTypeName, Person user) {
        ...
        boolean retVal = getPermissionService().isAuthorized(user.getPrincipalId(), Constants.MODULE_NAMESPACE_IACUC, PERMISSION_MAINTAIN_PERSON_TRAINING, permissionDetails);
        return retVal;
    }
    ...
    public boolean canMaintain(Object dataObject, Person user) {
        ...
        permissionDetails.put(KimConstants.AttributeConstants.DOCUMENT_TYPE_NAME,
                getDocumentDictionaryService().getMaintenanceDocumentTypeName(
                        dataObject.getClass()));
        permissionDetails.put(KRADConstants.MAINTENANCE_ACTN, Constants.MODULE_NAMESPACE_IACUC);
        return !permissionExistsByTemplate(Constants.MODULE_NAMESPACE_IACUC,
