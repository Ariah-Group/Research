...
public interface IacucProtocolProcedureService {
    ...
    /**
     * This method is to format procedure study group data, group by categories
     * for display
     *
     * @param iacucProtocol
     * @param allProcedures
    ...
    /**
     * This method is to remove a selected protocol study group Update the study
     * group species usage count
     *
     * @param selectedProtocolStudyGroupBean
    ...
    /**
     * This method is to set procedure summary tab details group studies by
     * protocol species group
     *
     * @param protocol
     */
     ...
     * This method is invoked during copy protocol so that we a new instance of
     * the study group is created and all its corresponding collections are set
    ...
    /**
     * This method is to update study procedures during protocol version We need
     * to reset those that are not a direct reference to protocol associate and
    ...
    /**
     * This method is to merge protocol procedure personnel during protocol
     * amend/renew
     *
     * @param destProtocol
     */
    ...
    /**
     * This method is to synchronize study details that are grouped based on
     * species
     *
     * @param iacucProtocol
     */
    ...
    /**
     * This method is to identify whether procedure is viewed by species or
     * group. If not by species, then procedure panel is displayed by group
