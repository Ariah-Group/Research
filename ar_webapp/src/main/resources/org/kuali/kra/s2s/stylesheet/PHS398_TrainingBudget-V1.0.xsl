				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
							...
							<xsl:for-each select="PHS398_TrainingBudget:BudgetYear">
								<fo:table font-family="Helvetica" line-height="11px" padding="0" table-layout="fixed" width="100%" border-spacing="0pt">
									...
									<fo:table-body margin="0" padding="0" start-indent="0pt">
												...
												<fo:table-row margin="0">
													<fo:table-cell margin="0" padding="0" padding-top="0" text-align="center" display-align="after">
														<fo:block>
															<fo:inline font-family="Helvetica" font-size="12px" font-weight="bold">
												...
												<fo:table-row margin="0">
													<fo:table-cell padding-left="25pt" padding-right="25pt" padding="1px" display-align="center">
														<fo:block>
															...
															<fo:table font-family="Helvetica" font-size="9px" line-height="11px" table-layout="fixed" width="100%" border-spacing="0pt">
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-body margin="0" padding="0" start-indent="0pt">
							...
							<fo:table font-family="Helvetica" font-size="9px" margin="0" padding="0" table-layout="fixed" width="100%" border-spacing="0pt">
								<fo:table-column column-width="proportional-column-width(1)"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="1px" text-align="center" display-align="center">
