...
Declare
  nextnum NUMBER;
 BEGIN
  select (MAX(AWARD_PERSON_ID)+1) into nextnum from AWARD_PERSONS;
...
Declare
  nextnum NUMBER;
 BEGIN
  select (MAX(AWARD_PERSON_UNIT_ID)+1) into nextnum from AWARD_PERSON_UNITS;
...
Declare
  nextnum NUMBER;
 BEGIN
  select (MAX(AWARD_PERSON_CREDIT_SPLIT_ID)+1) into nextnum from AWARD_PERSON_CREDIT_SPLITS;
