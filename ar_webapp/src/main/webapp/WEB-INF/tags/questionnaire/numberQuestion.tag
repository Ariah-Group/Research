...
<input type="text" class="Qanswer answer questionnaireAnswer" id="${prop}" name="${prop}" maxlength="${question.answerMaxLength}" size="${question.answerMaxLength}" value="${bean.answerHeaders[answerHeaderIndex].answers[questionIndex].answer}" />
