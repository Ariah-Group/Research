...
<input type="radio" class="questionnaireAnswer answer QanswerYesNoNa" name="${prop}" value="Y" ${answer == 'Y' ? "checked='true'" : ''}/>Yes
<input type="radio" class="questionnaireAnswer answer QanswerYesNoNa" name="${prop}" value="N" ${answer == 'N' ? "checked='true'" : ''}/>No
<input type="radio" class="questionnaireAnswer answer QanswerYesNoNa" name="${prop}" value="X" ${answer == 'X' ? "checked='true'" : ''}/>NA