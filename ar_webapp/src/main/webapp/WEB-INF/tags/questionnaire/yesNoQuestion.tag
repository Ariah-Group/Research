...
<input type="radio" class="questionnaireAnswer answer QanswerYesNo" name="${property}.answerHeaders[${answerHeaderIndex}].answers[${questionIndex}].answer" value="Y" ${answer == 'Y' ? "checked='true'" : ''}/>Yes
<input type="radio" class="questionnaireAnswer answer QanswerYesNo" name="${property}.answerHeaders[${answerHeaderIndex}].answers[${questionIndex}].answer" value="N" ${answer == 'N' ? "checked='true'" : ''}/>No