...
<kul:tabTop tabTitle="Proposal Development Rejection Confirmation" defaultOpen="true" tabErrorKey="ProposalDevelopmentRejectionBean*">
	...
	<table cellpadding=0 cellspacing=0 summary="">
		...
		<tr>
            <td style="text-align: center;" colspan="2">
            	...
            	<html:image property="methodToCall.rejectNo" src="${ConfigProperties.kr.externalizable.images.url}buttonsmall_No.gif" title="Don't Reject" alt="Don't Reject" styleClass="tinybutton"/>	                
            </td>
        </tr>
	</table>
	</div>
