...
<kul:tab tabTitle="Users" defaultOpen="true"  tabErrorKey="document.permissionsUser*,newPermissionsUser*">
            ...
            <kra:permission value="${modifyPermissions}">
                <tr class="addline">
                    ...
                    <td align="left" valign="middle">
                        <kul:htmlControlAttribute property="permissionsHelper.newUser.userName" attributeEntry="${permissionsUserAttributes.userName}" />
                    ...
                    <td align="left" valign="middle">
                        <kul:htmlControlAttribute property="permissionsHelper.newUser.fullName" attributeEntry="${permissionsUserAttributes.fullName}" readOnly="true" />
                    </td>

                    <td align="left" valign="middle">
                        <kul:htmlControlAttribute property="permissionsHelper.newUser.unitNumber" attributeEntry="${permissionsUserAttributes.unitNumber}" readOnly="true" />
                    </td>

                    <td align="left" valign="middle">
                        <kul:htmlControlAttribute property="permissionsHelper.newUser.unitName" attributeEntry="${permissionsUserAttributes.unitName}" readOnly="true" />
                    </td>

                    <td align="left" valign="middle">
                        <kul:htmlControlAttribute property="permissionsHelper.newUser.roleName" attributeEntry="${permissionsUserAttributes.roleName}" />
                    </td>

                    <td>
                        <div align="center">
                            <html:image property="methodToCall.addUser.anchor${tabKey}" src='${ConfigProperties.kra.externalizable.images.url}tinybutton-add1.gif' styleClass="tinybutton addButton"/>
                        </div>
                    </td>
                </tr>
            </kra:permission>
