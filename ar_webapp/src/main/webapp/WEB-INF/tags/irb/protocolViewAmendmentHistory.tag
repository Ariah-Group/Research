            ...
            <table id="amendHistoryTable" class="tab" cellpadding="0" cellspacing="0" summary="">
                <tbody>
                    ...
                    <c:forEach items="${amendmentSummaries}" var="protocolSummary" varStatus="status">
                        <tr>
                            <td><nobr><u><a href="${protocolSummary.versionNumberUrl}" target="_blank" alt="Open this version in a separate tab">${protocolSummary.amendmentType}</a></u></nobr></td>
                    <td><nobr><u><a href="${protocolSummary.versionNumberUrl}" target="_blank" alt="Open this version in a separate tab">${protocolSummary.versionNumber}</a></u></nobr></td>
                    <td><nobr>
                    ...
                    <td><nobr>${protocolSummary.status}</nobr></td>
                    <td><nobr>${protocolSummary.createDate}</nobr></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td class="infoline" colspan="5">
                            ...
                            <kul:innerTab tabTitle="${summaryTabTitle}" parentTab="" defaultOpen="false">
                                <div class="innerTab-container">
                                    ...
                                    <kra-irb:protocolSummary prefix="protocolSummary.amendRenewProtocol.protocolSummary" protocolSummary="${protocolSummary.amendRenewProtocol.protocolSummary}" />
                                </div>
                            </kul:innerTab>
                        </td>
                    </tr>
