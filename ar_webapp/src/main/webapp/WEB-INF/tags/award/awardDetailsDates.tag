            ...
            <table cellpAdding="0" cellspacing="0" summary="">
                ...
                <tr>
                    ...
                    <td align="left" valign="middle">
                        ...
                        <c:if test="${KualiForm.populateCustomAwardAccountNumberEnabled}">
                            &nbsp;
                            <html:image property="methodToCall.createAccountNumberCustom" 
                                        src="${ConfigProperties.kra.externalizable.images.url}tinybutton-create.gif" 
                                        title="Create Award Account Number" alt="Create Award Account Number" styleClass="tinybutton"/>
