    ...
    <div class="tab-container" align="center">
        ...
        <table id="approved-subaward-table" cellpadding="0" cellspacing="0" summary="Approved Subaward">
            ...
            <c:forEach var="awardApprovedSubawards" items="${KualiForm.document.awardList[0].awardApprovedSubawards}" varStatus="status">
                <tr>
                    <th width="5%" class="infoline">${status.index+1}</th>
        ...
        <table id="subaward-table" cellpadding="0" cellspacing="0" summary="Subawards">
            <tr>
                ...
                <th><div align="center">Obligated Amount:</div></th>
                <th><div align="center">Award Status:</div></th>
            </tr>
            <c:forEach var="awardLinkedSubawards" items="${KualiForm.document.awardList[0].subAwardList}" varStatus="status">
                <tr>
                    <td width="8%" valign="middle"> 
                        <a href="${ConfigProperties.application.url}/subAwardHome.do?methodToCall=docHandler&command=displayDocSearchView&docId=${awardLinkedSubawards.subAwardDocument.documentNumber}&medusaOpenedDoc=true&viewOnly=true" target="_blank" class="medusaOpenLink">Open Subaward</a>
                    </td>
