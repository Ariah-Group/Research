                ...
                <c:if test="${!readOnly}">                    
                    <tr>
                        ...
                        <td nowrap class="grid">
                            ...
                            <div id="org.fullName.div">&nbsp; <c:if test="${!empty KualiForm.sponsorContactsBean.newAwardContact.contact}">
                                    <c:choose>
                                        <c:when
                                        ...
                                        <c:otherwise>
                                            <c:out value="${KualiForm.sponsorContactsBean.newAwardContact.contact.contactOrganizationName}" />
                                        </c:otherwise>
                                    </c:choose>
                                </c:if></div>
                        </td>  
