    ...
    <div class="tab-container" align="center">
        ...
        <table cellpadding=0 cellspacing=0 summary="">
            ...
            <c:if test="${KualiForm.displayExecutiveSummary}" >
                <th><div align="right"><kul:htmlAttributeLabel attributeEntry="${proposalDevelopmentAttributes.executiveSummary}" /></div></th>
                <td align="left" valign="middle" colspan="3">
                    <kul:htmlControlAttribute property="document.developmentProposalList[0].executiveSummary" readOnly="true" attributeEntry="${proposalDevelopmentAttributes.executiveSummary}" />
                </td>
            </c:if>                           
            <c:if test="${not KualiForm.displayExecutiveSummary}" >
