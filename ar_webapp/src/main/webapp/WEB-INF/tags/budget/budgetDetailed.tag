...
<c:if test="${budgetCategoryTypeCodeKey eq KualiForm.budgetCategoryTypeCodeParticipantSupport}">
...
<c:if test="${! empty budgetLineItemSize or budgetCategoryTypeCodeKey ne KualiForm.budgetCategoryTypeCodeSubprojects}">
    <kul:tab tabTitle="${budgetCategoryTypeCodeLabel}" tabItemCount="${tabItemCount}" defaultOpen="false" tabErrorKey="*costElement*,newBudgetLineItems[${catCodes}].*,${tabErrorKeyString},${tabErrorKeyString2},${tabErrorKeyString3},${tabErrorKeyString4}"  auditCluster="budgetNonPersonnelAuditWarnings${budgetPeriod}${budgetCategoryTypeCodeLabel}" tabAuditKey="${tabErrorKeyString},${tabErrorKeyString2},${tabErrorKeyString3},${tabErrorKeyString4}" useRiceAuditMode="true">
        <div class="tab-container" align="center">
            <h3>
                ...
                <c:choose>
                    <c:when test="${proposalBudgetFlag}" >
                        <c:if test="${budgetCategoryTypeCodeKey eq KualiForm.budgetCategoryTypeCodeEquipment}">
                        ...
                        <c:if test="${budgetCategoryTypeCodeKey eq KualiForm.budgetCategoryTypeCodeTravel}">
                        ...
                        <c:if test="${budgetCategoryTypeCodeKey eq KualiForm.budgetCategoryTypeCodeSupplyMaterial}">
            ...
            <table border="0" cellpadding=0 cellspacing=0 summary="">
                ...
                <kra:section permission="modifyBudgets">    
                    <tr class="addline">
                        <th class="darkInfoline"><c:out value="Add:" /></th>
                        <td valign="middle" class="darkInfoline" nowrap="true">
                            <div align="center">
                                <html:select property="newBudgetLineItems[${catCodes}].costElement" tabindex="0" >
                                    <c:forEach items="${krafn:getOptionList('org.ariahgroup.research.budget.lookup.keyvalue.CostElementValuesFinder', paramMap)}" var="option">
                                        <c:choose>                    	
