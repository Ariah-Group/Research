...
<kul:innerTab parentTab="${parentTab}" tabTitle="${tabTitle}" defaultOpen="${KualiForm.negotiationAddActivityPanelOpenedByDefault}" tabErrorKey="${activityPath}*" useCurrentTabIndexAsKey="true" overrideDivClass="${tabDivClass}">
