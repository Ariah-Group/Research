        ...
        <kul:innerTab parentTab="${parentTabTitle}" tabTitle="Sponsor &amp; Program Information" tabDescription="Sponsor &amp; Program Information" defaultOpen="false">
            <div class="innerTab-container" align="left">
                <table cellpadding=0 cellspacing=0 summary="">
                    ...
                    <tr><th width="20%" align="right" valign="middle">Sponsor Div Name:</th><td width="30%" align="left" valign="middle">${proposal.agencyDivisionName}&nbsp;</td>
                        <th width="20%" align="right" valign="middle">Sponsor Program Name:</th><td width="30%" align="left" valign="middle">${proposal.agencyProgramName}&nbsp;</td></tr>                                
