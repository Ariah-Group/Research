    ...
    <script type="text/javascript">
        ...
        $j(document).ready(function () {
            ...
            if ($j(".financialEntitySubpanel").length > 0) {
                $j('.financialEntitySubpanel').click(function () {
                    var clicks = $j(this).data('financialEntitySubpanelClicked');
                    if (clicks) {
                    ...
                    $j(this).data("financialEntitySubpanelClicked", !clicks);
                });
            ...
            if ($j(".disclosedProjectsSubpanel").length > 0) {
                $j(".disclosedProjectsSubpanel").click(function () {
                    var clicks = $j(this).data('disclosedProjectsSubpanelClicked');
                    if (clicks) {
                        var controlId = $j(this).attr("id");
                        var contentId = controlId.replace("Control", "Content");
                        $j("#" + contentId).slideDown(500);
                    ...
                    $j(this).data("disclosedProjectsSubpanelClicked", !clicks);
                });
