...
<kul:documentPage showDocumentInfo="true"
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <p>
                <kul:documentControls transactionalDocument="true" viewOnly="${readOnly}"
            ...
            <SCRIPT type="text/javascript">
                        ...
                        function addToGlobalButtons() {
                            ...
                            var printdata = jQuery("#btn_print_content").html();
                            jQuery("#btn_print_content").remove();
                            setTimeout(function () {
                                jQuery("#globalbuttons").prepend(printdata);
