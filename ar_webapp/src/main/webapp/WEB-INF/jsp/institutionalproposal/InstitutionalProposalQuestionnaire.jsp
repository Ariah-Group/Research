...
<kul:documentPage
    ...
    htmlFormAction="institutionalProposalQuestionnaire"
    ...
    <div align="right"><kul:help documentTypeName="InstitutionalProposalDocument" pageName="Questionnaire" /></div>
    <kra-ip:institutionalProposalQuestionnaireAnswers property = "questionnaireHelper" bean = "${KualiForm.questionnaireHelper}"/>
