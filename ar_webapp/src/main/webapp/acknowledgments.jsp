...
<html>
    <head>
        <title>Ariah Research and Kuali Coeus Acknowledgements</title>
        <link href="css/screen.css" rel="stylesheet" type="text/css">
    </head>
    <body onload="placeFocus()">
        <table width="100%" border=0 cellpadding=0 cellspacing=0 class="headercell1">
            <tr>
                <td width="50%" align="left"><img src="static/images/logo.png" alt="Ariah Group, Inc." hspace=5 vspace=5></td>
            ...
            <tr>
                <td class="content" valign="top">
                    ...
                    <p><img src="http://opensource.org/trademarks/osi-certified/web/osi-certified-60x50.png" align="right" border="0" /><br/>
                        Copyright 2015 The Ariah Group, Inc.
                        <br>
                        Ariah Research is Licensed for use pursuant to the <a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License Version 2.0 </a>, which includes changes made after January 1, 2015 
                        to the original code of Kuali Coeus 5.2.1. All original copyright notices are maintained in their original source files, and where modified/updated, additional copyright notices
                        for the Apache License V 2.0 are appended. Questions about licensing of Ariah Research should be directed to info@ariahgroup.org .
                        <br><br>
                        Based on Kuali Coeus 5.2.1 which is copyright 2005-2014 The Kuali Foundation. All rights reserved. Kuali is licensed for use pursuant to the <a href="http://www.opensource.org/licenses/ecl2.php">Educational Community License, Version 2.0</a>. Portions of Kuali are copyrighted by other parties, including the parties listed below, and you should see the licenses directory for complete copyright and licensing information. Questions about licensing should be directed to <span class="nobr"><a href="mailto:licensing@kuali.org" title="Send mail to licensing@kuali.org" rel="nofollow">licensing@kuali.org</a>.</span></p>
