...
public class BudgetRatesServiceTest extends KcUnitTestBase {
    ...
    private void initializeBudgetProposalRates() {
        Budget budget = budgetDocument.getBudget();
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "1", "1", referenceStartDate, Constants.ON_CAMPUS_FLAG));
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "2", "1", referenceStartDate, Constants.ON_CAMPUS_FLAG));
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "2", "2", referenceStartDate, Constants.ON_CAMPUS_FLAG));
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "3", "1", referenceStartDate, Constants.ON_CAMPUS_FLAG));
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "3", "2", referenceStartDate, Constants.ON_CAMPUS_FLAG));
        budget.add(generateBudgetProposalRate(RESEARCH_ACTIVITY_CODE, "3", "3", referenceStartDate, Constants.ON_CAMPUS_FLAG));
    }
    ...
    private BudgetRate generateBudgetProposalRate(String activityTypeCode, String rateClassCode, String rateTypeCode, Date startDate, String onOffCampusFlag) {
        ...
        budgetRate.setOnOffCampusFlag(Constants.ON_CAMPUS_FLAG.equals(onOffCampusFlag));
    ...
    private void testViewLocation_DisplayLocation(List<AbstractBudgetRate> abstractBudgetRates, String trackAffectedPeriod, Integer budgetPeriod, 
        ...
        budgetRatesService.viewLocation(Constants.ON_CAMPUS_FLAG, budgetPeriod, budgetDocument.getBudget());
        for(AbstractBudgetRate rate: abstractBudgetRates) {
