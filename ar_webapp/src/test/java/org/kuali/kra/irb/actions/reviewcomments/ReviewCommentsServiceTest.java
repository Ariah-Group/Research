    ...
    private RoleService getMockRoleService1() {
        ...
        context.checking(new Expectations() {{
            allowing(kimRoleManagementService).getRoleMemberPrincipalIds("KC-UNT", RoleConstants.IRB_ADMINISTRATOR,
                    null);
            will(returnValue(adminIds));
            allowing(kimRoleManagementService).getRoleMemberPrincipalIds(Constants.MODULE_NAMESPACE_PROTOCOL, RoleConstants.PROTOCOL_AGGREGATOR,
                    null);
            will(returnValue(aggregatorIds));
            allowing(kimRoleManagementService).getRoleMemberPrincipalIds(Constants.MODULE_NAMESPACE_PROTOCOL, RoleConstants.PROTOCOL_VIEWER,
                    null);
