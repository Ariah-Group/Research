...
/**
 * This class is for SubAwardLookupableHelperServiceImpl for lookup searches...
 */
...
//          }
        ...
        for (SubAward subAward : collectionByQuery) {
            if (subrecipientName != null && !subrecipientName.isEmpty() && subAward.getOrganization().getOrganizationName() != null) {
        ...
        if (awardNumber != null && !awardNumber.isEmpty()) {

            Collection<Award> awards = getBusinessObjectService().findMatching(Award.class, ServiceHelper.getInstance().buildCriteriaMap(new String[]{AWARD_NUMBER}, new Object[]{awardNumber}));
            ...
            for (Award linkedAward : linkedAwards) {
                ...
                Collection<SubAwardFundingSource> subAwardFundingSource = getBusinessObjectService().findMatching(SubAwardFundingSource.class, ServiceHelper.getInstance().buildCriteriaMap(new String[]{"awardId"}, new Object[]{linkedAward.getAwardId()}));
