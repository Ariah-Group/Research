...
public class SubAwardAction extends KraTransactionalDocumentActionBase {
    ...
    protected void loadDocumentInForm(HttpServletRequest request,
        ...
        SubAwardDocument retrievedDocument = (SubAwardDocument) KRADServiceLocatorWeb.getDocumentService().
    ...
    /**
     * @see
     * org.kuali.kra.web.struts.action.KraTransactionalDocumentActionBase#loadDocument(
     ...
     * #save(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     */
    ...
    public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (subAwardForm.isHideSubawardDocDescriptionPanel()) {
            subAwardForm.getSubAwardDocument().defaultDocumentDescription();
        }
    ...
    /**
     * This method sets an subAwardCode on an subAward if the subAwardCode
    ...
    /**
     * This method is for medusa This method is for @throws Exception...
     *
     * @param mapping the ActionMapping
     * @param form the ActionForm
     * @param request the Request
