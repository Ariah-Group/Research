...
/**
 *
 * This class provides business logic for adding a protocol funding source to a
 * protocol. Also it uses newer paradigm for Event/Rule creation for reduced
 * Interface implementation in the ProtocolDocumentRule.
 */
