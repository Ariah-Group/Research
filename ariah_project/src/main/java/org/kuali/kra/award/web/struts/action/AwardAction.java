...
public class AwardAction extends BudgetParentActionBase {
    ...
    /**
     * @see
     * org.kuali.kra.web.struts.action.KraTransactionalDocumentActionBase#execute(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     */
    ...
    /**
     * @see
     * org.kuali.kra.web.struts.action.KraTransactionalDocumentActionBase#save(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     */
    ...
    /**
     * This method sets an award number on an award if the award number hasn't
     ...
     *
     * One of these conditions exist when this method is called: 1) This is a
     * new award, created from the "Create Award" portal action. A new root node
     * needs to be created a) prevAwardNumber and prevRootAwardNumber are null
     * b) awardHierarchyBean.rootNodes.size() == 0 2) This is a new award
     * created from a hierarchy action. The node for this award should exist on
     * the hierarchy bean a) prevAwardNumber and prevRootAwardNumber are ? b)
     * awardHierarchyBean.rootNodes.size() == ?
     */
    @Override
    ...
    /**
     * Create the original set of Award Users for a new Award Document. The
     * creator the award is assigned to the AWARD_MODIFIER role, if the creator
     * isn't already an AWARD_MODIFIER.
     *
     * @param doc
     */
    ...
    /**
     *
     * This method populates the initial static AwardCloseout reports upon the
    ...
    /**
     * Can the Award be saved? This method is normally overridden by a subclass
     * in order to invoke business rules to verify that the Award can be saved.
     *
    ...
    public void preSave(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        AwardForm awardForm = (AwardForm) form;
        if (awardForm.isHideAwardDocDescriptionPanel()) {
            awardForm.getAwardDocument().defaultDocumentDescription();
        }
    }
    ...
    /**
     * If an Award has associated Time and Money document or been versioned and
...
//    }
    ...
    /**
     * This method tests if the award is new by checking the size of
     * AwardDirectFandADistributions on the Award.
     *
     * @param awardForm
     * @return
     */
    ...
    /**
     *
     * This method gets called upon navigation to Payment, Reports and Terms
     * tab.
     *
     * @param mapping
     * @param form
    ...
    /**
     * This method sets up a sponsor template synchronization loop. It is called
     * by the ui when a specific set of scopes need to by synchronized. If no
     * scopes are in the request, then a full synchronization to the scopes:
     *
     * AWARD_PAGE SPONSOR_CONTACTS_TAB PAYMENTS_AND_INVOICES_TAB TERMS_TAB
     * REPORTS_TAB COMMENTS_TAB
     *
     ...
     * a particular scope is synchronized and then forwards to the method the
     * handles the request loop.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This method sets up a full template sync. This is called on return from a
     * Sponsor Template Lookup.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * KCAWD-494:If the user selects a sponsor template lookup, set a flag and
     * store the current sponsor template code in the form. The flag and the
     * current value will be used on the return to check if the template has
     * changed.
     *
     *
     * @see
     * org.kuali.rice.kns.web.struts.action.KualiAction#performLookup(org.apache.struts.action.ActionMapping,
     * org.apache.struts.action.ActionForm,
     * javax.servlet.http.HttpServletRequest,
     * javax.servlet.http.HttpServletResponse)
     */
    ...
    /**
     *
     * This should be called when an add or delete action is called that might
     * be added to the sync queue. It checks to ensure that syncMode is already
     * enabled and will return an ActionForward for the question or for the
     * returnForward specified by the caller.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * This should be called when a group add or delete action is called that
     * might be added to the sync queue. It checks to ensure that syncMode is
     * already enabled and will return an ActionForward for the question or for
     * the returnForward specified by the caller.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * When synchronizing a new addition or deletion call this method. It will
     * confirm the change and then add the change.
     *
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * If the user answers yes to a confirm sync action question call this
     * method.
     *
     * @param mapping
     * @param form
    ...
    /**
     * If the user answers no to a confirm sync action question call this
     * method.
     *
     * @param mapping
     * @param form
