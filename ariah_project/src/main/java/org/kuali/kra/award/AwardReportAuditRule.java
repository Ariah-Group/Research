...
/**
 * This class processes audit rules (warnings) for the Report Information
 * related data of the AwardDocument.
 */
    ...
    protected boolean evaluateAuditRuleForRecipients(AwardReportTerm awardReportTerm, int index) {
        ...
        for (int i = 0; i < recipients.size(); i++) {
            ...
            if (recipient.getRolodexId() == null) {
                addErrorToAuditErrors(KeyConstants.ERROR_REQUIRED_ORGANIZATION, new String[]{Integer.toString(i + 1)});
