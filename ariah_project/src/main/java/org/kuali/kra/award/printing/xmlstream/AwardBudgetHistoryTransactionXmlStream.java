...
public class AwardBudgetHistoryTransactionXmlStream extends AwardBudgetBaseStream {
    ...
    private AwardType getAwardType(Award award, int transactionIdx) {
        ...
        awardType.setAwardAmountInfo(getAwardAmountInfo(award, transactionIdx));
    ...
    private AmountInfoType setAwardAmountInfo(Award award,
            org.kuali.kra.award.home.AwardAmountInfo awardAmount, Long transacationIdValue) {
        AmountInfoType amountInfoType = AmountInfoType.Factory.newInstance();
        amountInfoType.setTransactionDate(dateTimeService.getCalendar(awardAmount.getUpdateTimestamp()));
        ...
        if (awardAmount.getFinalExpirationDate() != null) {
            amountInfoType.setFinalExpirationDate(dateTimeService.getCalendar(awardAmount.getFinalExpirationDate()));
        }
