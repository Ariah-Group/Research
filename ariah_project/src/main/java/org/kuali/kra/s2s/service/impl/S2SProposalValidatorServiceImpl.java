...
/**
 *
 * This class is meant to validate whether a given proposal is complete and
 * ready for submission to Grants.Gov. It applies different rules on the
 * Proposal and returns the result of the rule application. IN case of rule
 * failure, it fetches appropriate message and posts it back to user.
 *
...
public class S2SProposalValidatorServiceImpl implements S2SProposalValidatorService {
    ...
    /**
     * This method receives a ProposalDevelopmentDocument and applies all
     * Proposal validation rules on it, and returns back the validation result.
     * It also populates all the reasons for validation failure of rules in the
     * List that is also passed as argument
     *
     * @param pdDoc ProposalDevelopmentDocument
     * @param errors List of validation error messages.
     * @return boolean true if validation succeeds false otherwise.
     * @see
     * org.kuali.kra.s2s.service.S2SProposalValidatorService#validate(org.kuali.kra.proposaldevelopment.document.ProposalDevelopmentDocument,
     * java.util.List)
     */
