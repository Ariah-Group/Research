...
/**
 * Base implementation for all Task Authorizers. The Unit and Proposal
 * Authorization Services and KRA Workflow Services are defined here because
 * many derived classes make use of them.
 */
