...
-->
        ...
        <table cellpadding="4" cellspacing="0" summary="">
            ...
            <div align="right">
                <c:choose>
                    <c:when test="${KualiForm.displayDevelopmentProposal}">
                    ...
                    <c:when test="${KualiForm.displayIrbProtocol}">
                        IRB Protocol : 
                    </c:when>
                    <c:when test="${KualiForm.displayIacucProtocol}">
                        IACUC Protocol: 
                    </c:when>                                                        
                    ...
                    <c:choose>
                        ...
                        <c:when test="${KualiForm.displayIrbProtocol}">
                            <kul:lookup boClassName="org.kuali.kra.irb.Protocol" 
                                        fieldConversions="protocolNumber:document.negotiationList[0].associatedDocumentId" />
                        </c:when>                        
                        <c:when test="${KualiForm.displayIacucProtocol}">
