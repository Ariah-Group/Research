...
ALTER TABLE NEGOTIATION_ASSOCIATION_TYPE ADD DISABLED_COEUS_MODULE_ID NUMBER;

--add new negotiation association types
Insert into NEGOTIATION_ASSOCIATION_TYPE (NEGOTIATION_ASSC_TYPE_ID,NEGOTIATION_ASSC_TYPE_CODE,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ACTV_IND,DISABLED_COEUS_MODULE_ID)
values (6,'PD','Proposal Development',SYSDATE,'admin',0,SYS_GUID(),'Y',3);

Insert into NEGOTIATION_ASSOCIATION_TYPE (NEGOTIATION_ASSC_TYPE_ID,NEGOTIATION_ASSC_TYPE_CODE,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ACTV_IND,DISABLED_COEUS_MODULE_ID)
values (7,'IRB','IRB Protocol',SYSDATE,'admin',0,SYS_GUID(),'Y',7);

Insert into NEGOTIATION_ASSOCIATION_TYPE (NEGOTIATION_ASSC_TYPE_ID,NEGOTIATION_ASSC_TYPE_CODE,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ACTV_IND,DISABLED_COEUS_MODULE_ID) 
values (8,'IAC','IACUC Protocol',SYSDATE,'admin',0,SYS_GUID(),'Y',9);


update NEGOTIATION_ASSOCIATION_TYPE set DISABLED_COEUS_MODULE_ID=1 where NEGOTIATION_ASSC_TYPE_CODE='PL';
update NEGOTIATION_ASSOCIATION_TYPE set DISABLED_COEUS_MODULE_ID=2 where NEGOTIATION_ASSC_TYPE_CODE='IP';
update NEGOTIATION_ASSOCIATION_TYPE set DISABLED_COEUS_MODULE_ID=1 where NEGOTIATION_ASSC_TYPE_CODE='AWD';
update NEGOTIATION_ASSOCIATION_TYPE set DISABLED_COEUS_MODULE_ID=1 where NEGOTIATION_ASSC_TYPE_CODE='SWD';
