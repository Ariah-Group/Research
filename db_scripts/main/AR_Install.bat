...
:Version
set /p Version="Enter Currently Installed Version (NEW, 3.1.1, 5.0, 5.0.1, 5.1, 5.1.1, 5.2, 5.2.1, 5.3.0, 5.3.1, 5.3.2, 5.3.3, 5.3.4, 5.3.5, 5.4.0, 5.4.1) <%Version%>: "
...
if /i "%Version%" == "5.3.4" goto User
if /i "%Version%" == "5.3.5" goto User
if /i "%Version%" == "5.4.0" goto User
if /i "%Version%" == "5.4.1" goto User
...
sqlplus "%Riceun%"/"%Ricepw%"@"%RiceDBSvrNm%" < KR-RELEASE-5_3_5-Upgrade-ORACLE.sql
move *.log ../LOGS
cd ..
...
Echo    - Ver = Choose one: NEW, 5.3.5, 5.3.4, 5.3.3, 5.2.1, ...
Echo       - NEW = New install with an empty database schema
Echo       - 5.4.0, etc. = upgrading from 5.2.1 KC version, etc.
