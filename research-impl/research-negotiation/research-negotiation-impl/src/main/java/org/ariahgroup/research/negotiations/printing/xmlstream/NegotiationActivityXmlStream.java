 ...
 * limitations under the License.
 */
package org.ariahgroup.research.negotiations.printing.xmlstream;
...
public class NegotiationActivityXmlStream implements XmlStream {
    ...
    /**
     * This method generates XML for Negotiation Activity Report. It uses data
    ...
    protected NegotiationDataType getNegotiationDataType() {
        ...
        if (negotiationAssociationType != null
            ...
            proposalTypes.setProposalTypeDesc(getProposalTypeDescription(Integer.parseInt(negotiation.getAssociatedNegotiable().getNegotiableProposalTypeCode())));
