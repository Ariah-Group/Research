 ...
 */
package org.ariahgroup.research.negotiations.config;
...
public class NegotiationConfigurer extends AbstractConfigurer {
    ...
    private static final String NEGOTIATION_SPRING_BEANS_PATH = "classpath:/org/ariahgroup/research/negotiations/NegotiationSpringBeans.xml";

    public NegotiationConfigurer() {
        super("ar.negotiation", "AR Negotiation");
