 ...
 */
package org.ariahgroup.research.negotiations.web.struts.form;
...
import org.ariahgroup.research.negotiations.rules.NegotiationActivityAddRuleEvent;
import org.ariahgroup.research.negotiations.rules.NegotiationActivityAttachmentAddRuleEvent;
import org.ariahgroup.research.negotiations.rules.NegotiationActivityAttachmentRuleImpl;
import org.ariahgroup.research.negotiations.rules.NegotiationActivityRuleImpl;
import org.ariahgroup.research.negotiations.sorting.ActivitySortingType;
import org.ariahgroup.research.negotiations.sorting.AttachmentSortingType;
...
public class NegotiationActivityHelper implements Serializable {
    ...
    /**
     * Add the newActivity to the negotiation on the form also set as updated so
     * during the execute phase timestamps and last user update is updated.
     */
    ...
    /**
     * Find the activity at the specified index on the negotiation. If the index
     * is -1, the newActivity is returned.
     *
     * @param activityIndex
     * @return
     */
